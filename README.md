# Awesome Machine Learning [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 435,645 | 🐛 67 | 📅 2026-01-28 [![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/josephmisiti/awesome-machine-learning/) with stars
...
* For a list of free machine learning books available for download, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/books.md) ⭐ 71,602 | 🐛 10 | 🌐 Python | 📅 2026-01-29.

* For a list of professional machine learning events, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/events.md) ⭐ 71,602 | 🐛 10 | 🌐 Python | 📅 2026-01-29.

* For a list of (mostly) free machine learning courses available online, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/courses.md) ⭐ 71,602 | 🐛 10 | 🌐 Python | 📅 2026-01-29.

* For a list of blogs and newsletters on data science and machine learning, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/blogs.md) ⭐ 71,602 | 🐛 10 | 🌐 Python | 📅 2026-01-29.

* For a list of free-to-attend meetups and local events, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/meetups.md) ⭐ 71,602 | 🐛 10 | 🌐 Python | 📅 2026-01-29.
...
* [YOLOv8](https://github.com/ultralytics/ultralytics) ⭐ 53,021 | 🐛 350 | 🌐 Python | 📅 2026-02-07 - Ultralytics' YOLOv8 implementation with C++ support for real-time object detection and tracking, optimized for edge devices.
...
* [Openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 33,759 | 🐛 358 | 🌐 C++ | 📅 2024-08-03 - A real-time multi-person keypoint detection library for body, face, hands, and foot estimation
...
* [XGBoost](https://github.com/dmlc/xgboost) ⭐ 27,976 | 🐛 471 | 🌐 C++ | 📅 2026-02-07 - A parallelized optimized general purpose gradient boosting library.
...
* [LightGBM](https://github.com/Microsoft/LightGBM) ⭐ 18,066 | 🐛 479 | 🌐 C++ | 📅 2026-02-06 - Microsoft's fast, distributed, high performance gradient boosting (GBDT, GBRT, GBM or MART) framework based on decision tree algorithms, used for ranking, classification and many other machine learning tasks.
* [Opik](https://www.comet.com/site/products/opik/) - Open source engineering platform to debug, evaluate, and monitor your LLM applications, RAG systems, and agentic workflows with comprehensive tracing, automated evaluations, and production-ready dashboards. ([Source Code](https://github.com/comet-ml/opik/) ⭐ 17,668 | 🐛 128 | 🌐 Python | 📅 2026-02-06)
...
* [CatBoost](https://github.com/catboost/catboost) ⭐ 8,789 | 🐛 677 | 🌐 C++ | 📅 2026-02-06 - General purpose gradient boosting on decision trees library with categorical features support out of the box. It is easy to install, contains fast inference implementation and supports CPU and GPU (even multi-GPU) computation.
* [Vowpal Wabbit (VW)](https://github.com/VowpalWabbit/vowpal_wabbit) ⭐ 8,648 | 🐛 3 | 🌐 C++ | 📅 2026-02-06 - A fast out-of-core learning system.
...
* [Feast](https://github.com/gojek/feast) ⭐ 6,685 | 🐛 257 | 🌐 Python | 📅 2026-02-06 - A feature store for the management, discovery, and access of machine learning features. Feast provides a consistent view of feature data for both model training and model serving.
...
* [Warp-CTC](https://github.com/baidu-research/warp-ctc) ⭐ 4,077 | 🐛 89 | 🌐 Cuda | 📅 2024-03-04 - A fast parallel implementation of Connectionist Temporal Classification (CTC), on both CPU and GPU.
...
* * [Agentic Context Engine](https://github.com/kayba-ai/agentic-context-engine) ⭐ 1,828 | 🐛 16 | 🌐 Python | 📅 2026-02-06 -In-context learning framework that allows agents to learn from execution feedback.
* [nndeploy](https://github.com/nndeploy/nndeploy) ⭐ 1,708 | 🐛 20 | 🌐 C++ | 📅 2026-01-30 - An Easy-to-Use and High-Performance AI deployment framework.
...
* [SentencePiece](https://github.com/google/sentencepiece) ⭐ 11,627 | 🐛 24 | 🌐 C++ | 📅 2026-02-06 - A C++ library for unsupervised text tokenization and detokenization, widely used in modern NLP models.
...
* [Kaldi](https://github.com/kaldi-asr/kaldi) ⭐ 15,320 | 🐛 253 | 🌐 Shell | 📅 2025-09-22 - Kaldi is a toolkit for speech recognition written in C++ and licensed under the Apache License v2.0. Kaldi is intended for use by speech recognition researchers.
* [Vosk](https://github.com/alphacep/vosk-api) ⭐ 14,197 | 🐛 583 | 🌐 Jupyter Notebook | 📅 2025-12-08 - An offline speech recognition toolkit with C++ support, designed for low-resource devices and multiple languages.
...
* [tech.ml.dataset](https://github.com/techascent/tech.ml.dataset) ⭐ 736 | 🐛 30 | 🌐 Clojure | 📅 2026-02-03 - Clojure dataframe library and pipeline for data processing and machine learning
* [PigPen](https://github.com/Netflix/PigPen) ⭐ 565 | 🐛 19 | 🌐 Clojure | 📅 2023-04-10 - Map-Reduce for Clojure.
* [Tablecloth](https://github.com/scicloj/tablecloth) ⭐ 351 | 🐛 52 | 🌐 Clojure | 📅 2025-09-22 - A dataframe grammar wrapping tech.ml.dataset, inspired by several R libraries
...
* [Knowledge3D (K3D)](https://github.com/danielcamposramos/Knowledge3D) ⭐ 27 | 🐛 2 | 🌐 Python | 📅 2026-02-06 - Sovereign GPU-native spatial AI architecture with PTX-first cognitive engine (RPN/TRM reasoning), tri-modal fusion (text/visual/audio), and 3D persistent memory ("Houses"). Features sub-100µs inference, procedural knowledge compression (69:1 ratio), and multi-agent swarm architecture. Zero external dependencies for core inference paths.
...
* [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,910 | 🐛 119 | 🌐 Go | 📅 2024-08-12 - Deep learning in Go.
...
* [go-geom](https://github.com/twpayne/go-geom) ⭐ 953 | 🐛 9 | 🌐 Go | 📅 2025-11-20 - Go library to handle geometries.
...
* [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) ⭐ 1,285 | 🐛 19 | 🌐 Go | 📅 2022-04-02 - Dataframes for machine-learning and statistics (similar to pandas).
...
* [stable-baselines3](https://github.com/DLR-RM/stable-baselines3) ⭐ 12,699 | 🐛 79 | 🌐 Python | 📅 2026-01-23 - PyTorch implementations of Stable Baselines (deep) reinforcement learning algorithms.
...
* [H2O](https://github.com/h2oai/h2o-3) ⭐ 7,503 | 🐛 2,872 | 🌐 Jupyter Notebook | 📅 2026-02-07 - ML engine that supports distributed learning on Hadoop, Spark or your laptop via APIs in R, Python, Scala, REST/JSON.
...
* [Mahout](https://github.com/apache/mahout) ⭐ 2,205 | 🐛 56 | 🌐 Rust | 📅 2026-02-07 - Distributed machine learning.
...
* [Spark](https://github.com/apache/spark) ⭐ 42,764 | 🐛 250 | 🌐 Scala | 📅 2026-02-07 - Spark is a fast and general engine for large-scale data processing.
* [Hadoop](https://github.com/apache/hadoop) ⭐ 15,469 | 🐛 96 | 🌐 Java | 📅 2026-02-06 - Hadoop/HDFS.
...
* [Deeplearning4j](https://github.com/deeplearning4j/deeplearning4j) ⭐ 14,199 | 🐛 618 | 🌐 Java | 📅 2026-01-22 - Scalable deep learning for industry with parallel GPUs.
...
* [NLP Compromise](https://github.com/spencermountain/compromise) ⭐ 12,022 | 🐛 117 | 🌐 JavaScript | 📅 2025-12-12 - Natural Language processing in the browser.
* [natural](https://github.com/NaturalNode/natural) ⭐ 10,865 | 🐛 78 | 🌐 JavaScript | 📅 2025-11-03 - General natural language facilities for node.
...
* [cheminfo](https://www.cheminfo.org/) - Platform for data visualization and analysis, using the [visualizer](https://github.com/npellet/visualizer) ⭐ 51 | 🐛 186 | 🌐 JavaScript | 📅 2026-02-06 project.
...
* [Netron](https://github.com/lutzroeder/netron) ⭐ 32,353 | 🐛 20 | 🌐 JavaScript | 📅 2026-02-07 - Visualizer for machine learning models.
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [Brain.js](https://github.com/BrainJS/brain.js) ⭐ 14,857 | 🐛 91 | 🌐 TypeScript | 📅 2024-09-26 - Neural networks in JavaScript - continued community fork of [Brain](https://github.com/harthur/brain) ⚠️ Archived.
...
* [machinelearn.js](https://github.com/machinelearnjs/machinelearnjs) ⭐ 541 | 🐛 32 | 🌐 TypeScript | 📅 2026-01-21 - Machine Learning library for the web, Node.js and developers
...
* [stdlib](https://github.com/stdlib-js/stdlib) ⭐ 5,718 | 🐛 1,088 | 🌐 JavaScript | 📅 2026-02-06 - A standard library for JavaScript and Node.js, with an emphasis on numeric computing. The library provides a collection of robust, high performance libraries for mathematics, statistics, streams, utilities, and more.
...
* [Pipcook](https://github.com/alibaba/pipcook) ⭐ 2,587 | 🐛 110 | 🌐 TypeScript | 📅 2026-02-07 - A JavaScript application framework for machine learning and its engineering.
...
* [Clustering](https://github.com/JuliaStats/Clustering.jl) ⭐ 371 | 🐛 44 | 🌐 Julia | 📅 2025-11-24 - Basic functions for clustering data: k-means, dp-means, etc.
...
* [GaussianMixtures](https://github.com/davidavdav/GaussianMixtures.jl) ⭐ 103 | 🐛 23 | 🌐 Julia | 📅 2026-01-08 - Large scale Gaussian Mixture Models.
...
* [Distributions](https://github.com/JuliaStats/Distributions.jl) ⭐ 1,184 | 🐛 465 | 🌐 Julia | 📅 2026-02-05 - A Julia package for probability distributions and associated functions.
...
* [DSP](https://github.com/JuliaDSP/DSP.jl) ⭐ 413 | 🐛 87 | 🌐 Julia | 📅 2026-02-03 - Digital Signal Processing (filtering, periodograms, spectrograms, window functions).
* [SignalProcessing](https://github.com/JuliaDSP/DSP.jl) ⭐ 413 | 🐛 87 | 🌐 Julia | 📅 2026-02-03 - Signal Processing tools for Julia.
...
* [MXNet](https://github.com/apache/incubator-mxnet/) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [Pattern Recognition and Machine Learning](https://github.com/PRML/PRMLT) ⭐ 6,201 | 🐛 0 | 🌐 MATLAB | 📅 2020-03-04 - This package contains the matlab implementation of the algorithms described in the book Pattern Recognition and Machine Learning by C. Bishop.
...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 86,088 | 🐛 2,730 | 🌐 C++ | 📅 2026-02-06 - A OpenSource Computer Vision Library
...
* [face\_recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,100 | 🐛 832 | 🌐 Python | 📅 2024-08-21 - Face recognition library that recognizes and manipulates faces from Python or from the command line.
* [timm](https://github.com/rwightman/pytorch-image-models) ⭐ 36,330 | 🐛 75 | 🌐 Python | 📅 2026-02-06 - PyTorch image models, scripts, pretrained weights -- ResNet, ResNeXT, EfficientNet, EfficientNetV2, NFNet, Vision Transformer, MixNet, MobileNet-V3/V2, RegNet, DPN, CSPNet, and more.
* [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,048 | 🐛 582 | 🌐 Python | 📅 2025-11-17 - FAIR's next-generation research platform for object detection and segmentation. It is a ground-up rewrite of the previous version, Detectron, and is powered by the PyTorch deep learning framework.
* [Openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 33,759 | 🐛 358 | 🌐 C++ | 📅 2024-08-03 - A real-time multi-person keypoint detection library for body, face, hands, and foot estimation
...
* [MLX](https://github.com/ml-explore/mlx) ⭐ 23,818 | 🐛 158 | 🌐 C++ | 📅 2026-02-07- MLX is an array framework for machine learning on Apple silicon, developed by Apple machine learning research.
* [deepface](https://github.com/serengil/deepface) ⭐ 22,152 | 🐛 8 | 🌐 Python | 📅 2026-01-25 - A lightweight face recognition and facial attribute analysis (age, gender, emotion and race) framework for Python covering cutting-edge models such as VGG-Face, FaceNet, OpenFace, DeepFace, DeepID, Dlib and ArcFace.
...
* [pytessarct](https://github.com/madmaze/pytesseract) ⭐ 6,310 | 🐛 17 | 🌐 Python | 📅 2026-01-19 - Python-tesseract is an optical character recognition (OCR) tool for python. That is, it will recognize and "read" the text embedded in images. Python-tesseract is a wrapper for [Google's Tesseract-OCR Engine](https://github.com/tesseract-ocr/tesseract) ⭐ 72,282 | 🐛 463 | 🌐 C++ | 📅 2026-01-08.
...
* [imutils](https://github.com/jrosebr1/imutils) ⭐ 4,594 | 🐛 164 | 🌐 Python | 📅 2024-06-24 - A library containing Convenience functions to make basic image processing operations such as translation, rotation, resizing, skeletonization, and displaying Matplotlib images easier with OpenCV and Python.
* [Deep High-Resolution-Net](https://github.com/leoxiaobin/deep-high-resolution-net.pytorch) ⭐ 4,460 | 🐛 209 | 🌐 Cuda | 📅 2024-08-30 - A PyTorch implementation of CVPR2019 paper "Deep High-Resolution Representation Learning for Human Pose Estimation"
* [lightly](https://github.com/lightly-ai/lightly) ⭐ 3,675 | 🐛 80 | 🌐 Python | 📅 2025-12-19 - Lightly is a computer vision framework for self-supervised learning.
...
* [retinaface](https://github.com/serengil/retinaface) ⭐ 1,898 | 🐛 1 | 🌐 Python | 📅 2025-08-11 - deep learning based cutting-edge facial detector for Python coming with facial landmarks
* [LightlyTrain](https://github.com/lightly-ai/lightly-train) ⭐ 1,294 | 🐛 51 | 🌐 Python | 📅 2026-02-06 - Pretrain computer vision models on unlabeled data for industrial applications
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 156,169 | 🐛 2,215 | 🌐 Python | 📅 2026-02-07 - A deep learning library containing thousands of pre-trained models on different tasks. The goto place for anything related to Large Language Models.
* [jieba](https://github.com/fxsjy/jieba#jieba-1) ⭐ 34,742 | 🐛 697 | 🌐 Python | 📅 2024-08-21 - Chinese Words Segmentation Utilities.
* [spaCy](https://github.com/explosion/spaCy) ⭐ 33,170 | 🐛 186 | 🌐 Python | 📅 2025-11-27 - Industrial strength NLP with Python and Cython.
* [Haystack](https://github.com/deepset-ai/haystack) ⭐ 24,110 | 🐛 99 | 🌐 MDX | 📅 2026-02-06 - A framework for building industrial-strength applications with Transformer models and LLMs.
* [Rasa](https://github.com/RasaHQ/rasa) ⭐ 21,024 | 🐛 144 | 🌐 Python | 📅 2026-01-29 - A "machine learning framework to automate text-and voice-based conversations."
* [CometLLM](https://github.com/comet-ml/comet-llm) ⭐ 17,668 | 🐛 128 | 🌐 Python | 📅 2026-02-06 - Track, log, visualize and evaluate your LLM prompts and prompt chains.
...
* [SnowNLP](https://github.com/isnowfy/snownlp) ⭐ 6,604 | 🐛 44 | 🌐 Python | 📅 2020-01-19 - A library for processing Chinese text.
...
* [jellyfish](https://github.com/jamesturk/jellyfish) ⭐ 2,188 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2025-12-15 - a python library for doing approximate and phonetic matching of strings.
...
* [CLTK](https://github.com/cltk/cltk) ⭐ 884 | 🐛 8 | 🌐 Python | 📅 2026-01-25 - The Classical Language Toolkit.
* [NobodyWho](https://github.com/nobodywho-ooo/nobodywho) ⭐ 693 | 🐛 30 | 🌐 Rust | 📅 2026-02-06 - The simplest way to run an LLM locally. Supports tool calling and grammar constrained sampling.
...
* [TensorFlow](https://github.com/tensorflow/tensorflow/) ⭐ 193,635 | 🐛 3,288 | 🌐 C++ | 📅 2026-02-07 - Open source software library for numerical computation using data flow graphs.
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 97,215 | 🐛 17,987 | 🌐 Python | 📅 2026-02-07 - Tensors and Dynamic neural networks in Python with strong GPU acceleration
* [keras](https://github.com/keras-team/keras) ⭐ 63,754 | 🐛 255 | 🌐 Python | 📅 2026-02-07 - High-level neural networks frontend for [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 193,635 | 🐛 3,288 | 🌐 C++ | 📅 2026-02-07, [CNTK](https://github.com/Microsoft/CNTK) ⭐ 17,617 | 🐛 839 | 🌐 C++ | 📅 2023-03-11 and [Theano](https://github.com/Theano/Theano) ⭐ 9,986 | 🐛 698 | 🌐 Python | 📅 2024-01-15.
* [Streamlit](https://github.com/streamlit/streamlit) ⭐ 43,379 | 🐛 1,299 | 🌐 Python | 📅 2026-02-07: Streamlit is an framework to create beautiful data apps in hours, not weeks.
* [Gradio](https://github.com/gradio-app/gradio) ⭐ 41,593 | 🐛 478 | 🌐 Python | 📅 2026-02-02 - A Python library for quickly creating and sharing demos of models. Debug models interactively in your browser, get feedback from collaborators, and generate public links without deploying anything.
* [Colossal-AI](https://github.com/hpcaitech/ColossalAI) ⭐ 41,338 | 🐛 489 | 🌐 Python | 📅 2026-01-19: An open-source deep learning system for large-scale model training and inference with high efficiency and low cost.
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 38,409 | 🐛 171 | 🌐 Python | 📅 2026-02-07 - Open Source framework to streamline use of neural networks.
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,835 | 🐛 1,176 | 🌐 C++ | 📅 2024-07-31 - A deep learning framework developed with cleanliness, readability, and speed in mind.
* [JAX](https://github.com/google/jax) ⭐ 34,808 | 🐛 2,452 | 🌐 Python | 📅 2026-02-07 - JAX is Autograd and XLA, brought together for high-performance machine learning research.
* [PyTorch Lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 30,807 | 🐛 942 | 🌐 Python | 📅 2026-02-04 - The lightweight PyTorch wrapper for high-performance AI research.
* [ML-From-Scratch](https://github.com/eriklindernoren/ML-From-Scratch) ⭐ 30,637 | 🐛 69 | 🌐 Python | 📅 2023-10-15 - Implementations of Machine Learning models from scratch in Python with a focus on transparency. Aims to showcase the nuts and bolts of ML in an accessible way.
* [Bayesian Methods for Hackers](https://github.com/CamDavidsonPilon/Probabilistic-Programming-and-Bayesian-Methods-for-Hackers) ⭐ 28,473 | 🐛 205 | 🌐 Jupyter Notebook | 📅 2024-06-25 - Book/iPython notebooks on Probabilistic Programming in Python.
* [XGBoost](https://github.com/dmlc/xgboost) ⭐ 27,976 | 🐛 471 | 🌐 C++ | 📅 2026-02-07 - Python bindings for eXtreme Gradient Boosting (Tree) Library.
* [Fastai](https://github.com/fastai/fastai) ⭐ 27,829 | 🐛 267 | 🌐 Jupyter Notebook | 📅 2026-01-29 - High-level wrapper built on the top of Pytorch which supports vision, text, tabular data and collaborative filtering.
* [PyTorch Geometric](https://github.com/pyg-team/pytorch_geometric) ⭐ 23,456 | 🐛 1,263 | 🌐 Python | 📅 2026-02-05 -> Graph Neural Network Library for PyTorch.
* [Microsoft Recommenders](https://github.com/Microsoft/Recommenders) ⭐ 21,434 | 🐛 169 | 🌐 Python | 📅 2026-02-06: Examples and best practices for building recommendation systems, provided as Jupyter notebooks. The repo contains some of the latest state of the art algorithms from Microsoft Research as well as from other companies and institutions.
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [Opik](https://github.com/comet-ml/opik) ⭐ 17,668 | 🐛 128 | 🌐 Python | 📅 2026-02-06: Evaluate, trace, test, and ship LLM applications across your dev and production lifecycles.
...
* [Neural Networks and Deep Learning](https://github.com/mnielsen/neural-networks-and-deep-learning) ⭐ 17,412 | 🐛 7 | 🌐 Python | 📅 2024-06-02 - Code samples for my book "Neural Networks and Deep Learning" \[DEEP LEARNING].
* [gensim](https://github.com/RaRe-Technologies/gensim) ⭐ 16,349 | 🐛 435 | 🌐 Python | 📅 2025-11-01 - Topic Modelling for Humans.
...
* [Annoy](https://github.com/spotify/annoy) ⭐ 14,147 | 🐛 75 | 🌐 C++ | 📅 2025-10-29 - Approximate nearest neighbours implementation.
* [Optuna](https://github.com/optuna/optuna) ⭐ 13,477 | 🐛 32 | 🌐 Python | 📅 2026-02-04: Optuna is an automatic hyperparameter optimization software framework, particularly designed for machine learning.
* [cleanlab](https://github.com/cleanlab/cleanlab) ⭐ 11,306 | 🐛 98 | 🌐 Python | 📅 2026-01-13: The standard data-centric AI package for data quality and machine learning with messy, real-world data and labels.
...
* [AutoGluon](https://github.com/awslabs/autogluon) ⭐ 9,867 | 🐛 389 | 🌐 Python | 📅 2026-02-05: AutoML for Image, Text, Tabular, Time-Series, and MultiModal Data.
* [PySyft](https://github.com/OpenMined/PySyft) ⭐ 9,849 | 🐛 63 | 🌐 Python | 📅 2025-07-15 - A Python library for secure and private Deep Learning built on PyTorch and TensorFlow.
* [PyOD](https://github.com/yzhao062/pyod) ⭐ 9,701 | 🐛 240 | 🌐 Python | 📅 2026-01-05 -> Python Outlier Detection, comprehensive and scalable Python toolkit for detecting outlying objects in multivariate data. Featured for Advanced models, including Neural Networks/Deep Learning and Outlier Ensembles.
...
* [sktime](https://github.com/alan-turing-institute/sktime) ⭐ 9,483 | 🐛 1,746 | 🌐 Python | 📅 2026-02-06 - A unified framework for machine learning with time series
* [einops](https://github.com/arogozhnikov/einops) ⭐ 9,388 | 🐛 33 | 🌐 Python | 📅 2026-01-26 - Deep learning operations reinvented (for pytorch, tensorflow, jax and others).
* [Hub](https://github.com/activeloopai/Hub) ⭐ 8,993 | 🐛 61 | 🌐 C++ | 📅 2026-02-07 - Fastest unstructured dataset management for TensorFlow/PyTorch. Stream & version-control data. Store even petabyte-scale data in a single numpy-like array on the cloud accessible on any machine. Visit [activeloop.ai](https://activeloop.ai) for more info.
* [pattern](https://github.com/clips/pattern) ⭐ 8,855 | 🐛 176 | 🌐 Python | 📅 2024-06-10 - Web mining module for Python.
* [CatBoost](https://github.com/catboost/catboost) ⭐ 8,789 | 🐛 677 | 🌐 C++ | 📅 2026-02-06 - General purpose gradient boosting on decision trees library with categorical features support out of the box. It is easy to install, well documented and supports CPU and GPU (even multi-GPU) computation.
* [BentoML](https://github.com/bentoml/bentoml) ⭐ 8,412 | 🐛 137 | 🌐 Python | 📅 2026-02-03: Toolkit for package and deploy machine learning models for serving in production
...
* [InterpretML](https://github.com/interpretml/interpret) ⭐ 6,790 | 🐛 111 | 🌐 C++ | 📅 2026-02-06 - InterpretML implements the Explainable Boosting Machine (EBM), a modern, fully interpretable machine learning model based on Generalized Additive Models (GAMs). This open-source package also provides visualization tools for EBMs, other glass-box models, and black-box explanations.
...
* [Aim](https://github.com/aimhubio/aim) ⭐ 5,986 | 🐛 450 | 🌐 Python | 📅 2026-02-06 -> An easy-to-use & supercharged open-source AI metadata tracker.
...
* [Deepchecks](https://github.com/deepchecks/deepchecks) ⭐ 3,973 | 🐛 257 | 🌐 Python | 📅 2025-12-28: Validation & testing of machine learning models and data during model development, deployment, and production. This includes checks and suites related to various types of issues, such as model performance, data integrity, distribution mismatches, and more.
...
* [pomegranate](https://github.com/jmschrei/pomegranate) ⭐ 3,508 | 🐛 39 | 🌐 Python | 📅 2025-03-06 - Hidden Markov Models for Python, implemented in Cython for speed and efficiency.
* [Catalyst](https://github.com/catalyst-team/catalyst) ⭐ 3,371 | 🐛 2 | 🌐 Python | 📅 2025-06-27 - High-level utils for PyTorch DL & RL research. It was developed with a focus on reproducibility, fast experimentation and code/ideas reusing. Being able to research/develop something new, rather than write another regular train loop.
* [mljar-supervised](https://github.com/mljar/mljar-supervised) ⭐ 3,241 | 🐛 146 | 🌐 Python | 📅 2025-07-07 - An Automated Machine Learning (AutoML) python package for tabular data. It can handle: Binary Classification, MultiClass Classification and Regression. It provides explanations and markdown reports.
...
* [pgmpy](https://github.com/pgmpy/pgmpy) ⭐ 3,148 | 🐛 429 | 🌐 Python | 📅 2026-02-06 A python library for working with Probabilistic Graphical Models.
...
* [PyBroker](https://github.com/edtechre/pybroker) ⭐ 3,085 | 🐛 4 | 🌐 Python | 📅 2026-02-03 - Algorithmic Trading with Machine Learning.
* [Shogun](https://github.com/shogun-toolbox/shogun) ⭐ 3,065 | 🐛 423 | 🌐 C++ | 📅 2023-12-19 - The Shogun Machine Learning Toolbox.
...
* [PyTorch Geometric Temporal](https://github.com/benedekrozemberczki/pytorch_geometric_temporal) ⭐ 2,943 | 🐛 29 | 🌐 Python | 📅 2025-09-18 -> A temporal extension of PyTorch Geometric for dynamic graph representation learning.
...
* [Feature-engine](https://github.com/feature-engine/feature_engine) ⭐ 2,194 | 🐛 75 | 🌐 Python | 📅 2026-02-07 - Open source library with an exhaustive battery of feature engineering and selection methods based on pandas and scikit-learn.
...
* [Intel(R) Extension for Scikit-learn](https://github.com/intel/scikit-learn-intelex) ⭐ 1,328 | 🐛 79 | 🌐 Python | 📅 2026-02-07 - A seamless way to speed up your Scikit-learn applications with no accuracy loss and code changes.
...
* [MCP Memory Service](https://github.com/doobidoo/mcp-memory-service) ⭐ 1,277 | 🐛 12 | 🌐 Python | 📅 2026-02-06 - Universal memory service with semantic search, autonomous consolidation, and multi-client support for AI applications.
...
* [REP](https://github.com/yandex/rep) ⭐ 699 | 🐛 31 | 🌐 Jupyter Notebook | 📅 2024-07-31 - an IPython-based environment for conducting data-driven research in a consistent and reproducible way. REP is not trying to substitute scikit-learn, but extends it and provides better user experience. **\[Deprecated]**
...
* [machine learning](https://github.com/jeff1evesque/machine-learning) ⭐ 262 | 🐛 78 | 🌐 JavaScript | 📅 2021-02-17 - automated build consisting of a [web-interface](https://github.com/jeff1evesque/machine-learning#web-interface) ⭐ 262 | 🐛 78 | 🌐 JavaScript | 📅 2021-02-17, and set of [programmatic-interface](https://github.com/jeff1evesque/machine-learning#programmatic-interface) ⭐ 262 | 🐛 78 | 🌐 JavaScript | 📅 2021-02-17 API, for support vector machines. Corresponding dataset(s) are stored into a SQL database, then generated model(s) used for prediction(s), are stored into a NoSQL datastore.
...
* [Neurolink](https://github.com/juspay/neurolink) ⭐ 103 | 🐛 417 | 🌐 TypeScript | 📅 2026-02-06 - Enterprise-grade LLM integration framework for building production-ready AI applications with built-in hallucination prevention, RAG, and MCP support.
...
* [Superset](https://github.com/apache/incubator-superset) ⭐ 70,457 | 🐛 1,102 | 🌐 TypeScript | 📅 2026-02-07 - A data exploration platform designed to be visual, intuitive, and interactive.
* [Dash](https://github.com/plotly/dash) ⭐ 24,458 | 🐛 557 | 🌐 Python | 📅 2026-02-05 - A framework for creating analytical web applications built on top of Plotly.js, React, and Flask
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,325 | 🐛 867 | 🌐 TypeScript | 📅 2026-02-06 - Interactive Web Plotting for Python.
* [zipline](https://github.com/quantopian/zipline) ⭐ 19,387 | 🐛 367 | 🌐 Python | 📅 2024-02-13 - A Pythonic algorithmic trading library.
* [SymPy](https://github.com/sympy/sympy) ⭐ 14,364 | 🐛 5,553 | 🌐 Python | 📅 2026-02-06 - A Python library for symbolic mathematics.
* [lime](https://github.com/marcotcr/lime) ⭐ 12,100 | 🐛 131 | 🌐 JavaScript | 📅 2024-07-25 - Lime is about explaining what machine learning classifiers (or models) are doing. It is able to explain any black box classifier, with two or more classes.
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,232 | 🐛 2,969 | 🌐 Python | 📅 2026-01-13 - Statistical modelling and econometrics in Python.
* [altair](https://github.com/altair-viz/altair) ⭐ 10,242 | 🐛 157 | 🌐 Python | 📅 2026-02-06 - A Python to Vega translator.
* [PyMC](https://github.com/pymc-devs/pymc) ⭐ 9,478 | 🐛 460 | 🌐 Python | 📅 2026-02-04 - Markov Chain Monte Carlo sampling toolkit.
...
* [ggplot](https://github.com/yhat/ggpy) ⭐ 3,699 | 🐛 178 | 🌐 Python | 📅 2023-01-21 - Same API as ggplot2 for R. **\[Deprecated]**
* [bqplot](https://github.com/bloomberg/bqplot) ⭐ 3,682 | 🐛 277 | 🌐 TypeScript | 📅 2026-01-23 - An API for plotting in Jupyter (IPython).
* [vispy](https://github.com/vispy/vispy) ⭐ 3,539 | 🐛 377 | 🌐 Python | 📅 2026-01-14 - GPU-based high-performance interactive OpenGL 2D/3D data visualization library.
...
* [emcee](https://github.com/dfm/emcee) ⭐ 1,563 | 🐛 67 | 🌐 Python | 📅 2026-01-19 - The Python ensemble sampling toolkit for affine-invariant MCMC.
...
* [d3py](https://github.com/mikedewar/d3py) ⭐ 1,420 | 🐛 48 | 🌐 Python | 📅 2020-12-28 - A plotting library for Python, based on [D3.js](https://d3js.org/).
...
* [data-science-ipython-notebooks](https://github.com/donnemartin/data-science-ipython-notebooks) ⭐ 28,852 | 🐛 42 | 🌐 Python | 📅 2024-03-20 - Continually updated Data Science Python Notebooks: Spark, Hadoop MapReduce, HDFS, AWS, Kaggle, scikit-learn, matplotlib, pandas, NumPy, SciPy, and various command lines.
...
* [Pydata book](https://github.com/wesm/pydata-book) ⭐ 24,269 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2025-10-17 - Materials and IPython notebooks for "Python for Data Analysis" by Wes McKinney, published by O'Reilly Media
* [Homemade Machine Learning](https://github.com/trekhleb/homemade-machine-learning) ⭐ 24,180 | 🐛 27 | 🌐 Jupyter Notebook | 📅 2025-11-23 - Python examples of popular machine learning algorithms with interactive Jupyter demos and math being explained
...
* [Introduction to Machine Learning with Python](https://github.com/amueller/introduction_to_ml_with_python) ⭐ 8,008 | 🐛 28 | 🌐 Jupyter Notebook | 📅 2024-03-14 - Notebooks and code for the book "Introduction to Machine Learning with Python"
...
* [minidiff](https://github.com/ahoynodnarb/minidiff) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-01-27 - A slightly larger, somewhat feature-complete, PyTorch-inspired, NumPy implementation of a tensor reverse-mode automatic differentiation engine.
...
* [NeuralTalk](https://github.com/karpathy/neuraltalk) ⭐ 5,478 | 🐛 30 | 🌐 Python | 📅 2020-12-22 - NeuralTalk is a Python+numpy project for learning Multimodal Recurrent Neural Networks that describe images with sentences.
...
* [Sinabs](https://github.com/synsense/sinabs) ⭐ 108 | 🐛 27 | 🌐 Python | 📅 2026-02-05 - A deep learning library for spiking neural networks which is based on PyTorch, focuses on fast training and supports inference on neuromorphic hardware.
...
* [lifelines](https://github.com/CamDavidsonPilon/lifelines) ⭐ 2,545 | 🐛 278 | 🌐 Python | 📅 2026-02-04 - lifelines is a complete survival analysis library, written in pure Python
* [Scikit-Survival](https://github.com/sebp/scikit-survival) ⭐ 1,264 | 🐛 28 | 🌐 Python | 📅 2026-02-02 - scikit-survival is a Python module for survival analysis built on top of scikit-learn. It allows doing survival analysis while utilizing the power of scikit-learn, e.g., for pre-processing or doing cross-validation.
...
* [PySyft](https://github.com/OpenMined/PySyft) ⭐ 9,849 | 🐛 63 | 🌐 Python | 📅 2025-07-15 - A Python library for secure and private Deep Learning.
...
* [RLlib](https://github.com/ray-project/ray) ⭐ 41,169 | 🐛 3,344 | 🌐 Python | 📅 2026-02-07 - RLlib is an industry level, highly scalable RL library for tf and torch, based on Ray. It's used by companies like Amazon and Microsoft to solve real-world decision making problems at scale.
* [Gymnasium](https://github.com/Farama-Foundation/Gymnasium) ⭐ 11,277 | 🐛 84 | 🌐 Python | 📅 2026-02-02 - A library for developing and comparing reinforcement learning algorithms (successor of \[gym])(<https://github.com/openai/gym> ⭐ 37,021 | 🐛 127 | 🌐 Python | 📅 2024-10-11).
...
* [garage](https://github.com/rlworkgroup/garage) ⭐ 2,074 | 🐛 234 | 🌐 Python | 📅 2023-05-04 - A toolkit for reproducible reinforcement learning research
* [ViZDoom](https://github.com/mwydmuch/ViZDoom) ⭐ 1,970 | 🐛 37 | 🌐 C++ | 📅 2026-02-06 - ViZDoom allows developing AI bots that play Doom using only the visual information (the screen buffer). It is primarily intended for research in machine visual learning, and deep reinforcement learning, in particular.
...
* [EspNet](https://github.com/espnet/espnet) ⭐ 9,720 | 🐛 52 | 🌐 Python | 📅 2026-02-05 - ESPnet is an end-to-end speech processing toolkit for tasks like speech recognition, translation, and enhancement, using PyTorch and Kaldi-style data processing.
...
* [Awesome NLP with Ruby](https://github.com/arbox/nlp-with-ruby) ⭐ 1,072 | 🐛 7 | 🌐 Ruby | 📅 2023-06-27 - Curated link list for practical natural language processing in Ruby.
...
* [rumale](https://github.com/yoshoku/rumale) ⭐ 898 | 🐛 0 | 🌐 Ruby | 📅 2026-01-11 - Rumale is a machine learning library in Ruby
* [CardMagic-Classifier](https://github.com/cardmagic/classifier) ⭐ 714 | 🐛 14 | 🌐 Ruby | 📅 2026-01-31 - A general classifier module to allow Bayesian and other types of classifications.
...
* [candle](https://github.com/huggingface/candle) ⭐ 19,292 | 🐛 601 | 🌐 Rust | 📅 2026-02-06 - Candle is a minimalist ML framework for Rust with a focus on performance (including GPU support) and ease of use.
...
* [burn](https://github.com/tracel-ai/burn) ⭐ 14,258 | 🐛 218 | 🌐 Rust | 📅 2026-02-06 - Burn is a new comprehensive dynamic Deep Learning Framework built using Rust with extreme flexibility, compute efficiency and portability as its primary goals
* [tch-rs](https://github.com/LaurentMazare/tch-rs) ⭐ 5,261 | 🐛 227 | 🌐 Rust | 📅 2026-01-22 - Rust bindings for the C++ API of PyTorch
* [dfdx](https://github.com/coreylowman/dfdx) ⭐ 1,892 | 🐛 90 | 🌐 Rust | 📅 2024-07-23 - Deep learning in Rust, with shape checked tensors and neural networks

#### Natural Language Processing

* [huggingface/tokenizers](https://github.com/huggingface/tokenizers) ⭐ 10,454 | 🐛 146 | 🌐 Rust | 📅 2026-02-06 - Fast State-of-the-Art Tokenizers optimized for Research and Production
* [shimmy](https://github.com/Michael-A-Kuykendall/shimmy) ⭐ 3,656 | 🐛 28 | 🌐 Rust | 📅 2026-01-16 - Python-free Rust inference server for NLP models with OpenAI API compatibility and hot model swapping.
* [rust-bert](https://github.com/guillaume-be/rust-bert) ⭐ 3,034 | 🐛 73 | 🌐 Rust | 📅 2026-01-13 - Rust native ready-to-use NLP pipelines and transformer-based models (BERT, DistilBERT, GPT2,...)
...
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [CatBoost](https://github.com/catboost/catboost) ⭐ 8,789 | 🐛 677 | 🌐 C++ | 📅 2026-02-06 - General purpose gradient boosting on decision trees library with categorical features support out of the box for R.
...
* [Spark NLP](https://github.com/JohnSnowLabs/spark-nlp) ⭐ 4,106 | 🐛 19 | 🌐 Scala | 📅 2026-02-06 - Natural language processing library built on top of Apache Spark ML to provide simple, performant, and accurate NLP annotations for machine learning pipelines, that scale easily in a distributed environment.
...
* [Awesome Core ML Models](https://github.com/likedan/Awesome-CoreML-Models) ⭐ 6,942 | 🐛 11 | 🌐 Python | 📅 2025-06-17 - A curated list of machine learning models in CoreML format.
...
* [milvus](https://milvus.io) – Milvus is [open source](https://github.com/milvus-io/milvus) ⭐ 42,653 | 🐛 986 | 🌐 Go | 📅 2026-02-07 vector database for production AI, written in Go and C++, scalable and blazing fast for billions of embedding vectors.
* [Qdrant](https://qdrant.tech) – Qdrant is [open source](https://github.com/qdrant/qdrant) ⭐ 28,628 | 🐛 459 | 🌐 Rust | 📅 2026-02-06 vector similarity search engine with extended filtering support, written in Rust.
* [Weaviate](https://www.semi.technology/developers/weaviate/current/) – Weaviate is an [open source](https://github.com/semi-technologies/weaviate) ⭐ 15,541 | 🐛 578 | 🌐 Go | 📅 2026-02-06 vector search engine and vector database. Weaviate uses machine learning to vectorize and store data, and to find answers to natural language queries. With Weaviate you can also bring your custom ML models to production scale.
* [DVC](https://github.com/iterative/dvc) ⭐ 15,342 | 🐛 166 | 🌐 Python | 📅 2026-02-01 - Data Science Version Control is an open-source version control system for machine learning projects with pipelines support. It makes ML projects reproducible and shareable.
* [txtai](https://github.com/neuml/txtai) ⭐ 12,111 | 🐛 6 | 🌐 Python | 📅 2026-02-04 - Build semantic search applications and workflows.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 10,330 | 🐛 214 | 🌐 TypeScript | 📅 2026-02-07 - Open-source LLM evaluation and red teaming framework. Test prompts, models, agents, and RAG pipelines. Run adversarial attacks (jailbreaks, prompt injection) and integrate security testing into CI/CD.
* [PraisonAI](https://github.com/MervinPraison/PraisonAI) ⭐ 5,592 | 🐛 59 | 🌐 Python | 📅 2026-02-05 - Production-ready Multi-AI Agents framework with self-reflection. Fastest agent instantiation (3.77μs), 100+ LLM support via LiteLLM, MCP integration, agentic workflows (route/parallel/loop/repeat), built-in memory, Python & JS SDKs.
* [Infinity](https://github.com/infiniflow/infinity) ⭐ 4,379 | 🐛 141 | 🌐 C++ | 📅 2026-02-06 - The AI-native database built for LLM applications, providing incredibly fast vector and full-text search. Developed using C++20
...
* More tools to improve the ML lifecycle: [Catalyst](https://github.com/catalyst-team/catalyst) ⭐ 3,371 | 🐛 2 | 🌐 Python | 📅 2025-06-27, [PachydermIO](https://www.pachyderm.io/). The following are GitHub-alike and targeting teams [Weights & Biases](https://www.wandb.com/), [Neptune.ai](https://neptune.ai/), [Comet.ml](https://www.comet.ml/), [Valohai.ai](https://valohai.com/), [DAGsHub](https://DAGsHub.com/).
...
* [Deepnote](https://github.com/deepnote/deepnote) ⭐ 2,626 | 🐛 16 | 🌐 TypeScript | 📅 2026-02-06 - Deepnote is a drop-in replacement for Jupyter with an AI-first design, sleek UI, new blocks, and native data integrations. Use Python, R, and SQL locally in your favorite IDE, then scale to Deepnote cloud for real-time collaboration, Deepnote agent, and deployable data apps.
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,391 | 🐛 169 | 🌐 Jupyter Notebook | 📅 2026-02-06 - a lightweight library to define data transformations as a directed-acyclic graph (DAG). It helps author reliable feature engineering and machine learning pipelines, and more.
...
* [Agentic Radar](https://github.com/splx-ai/agentic-radar) ⭐ 904 | 🐛 10 | 🌐 Python | 📅 2025-11-27 -  Open-source CLI security scanner for agentic workflows. Scans your workflow’s source code, detects vulnerabilities, and generates an interactive visualization along with a detailed security report. Supports LangGraph, CrewAI, n8n, OpenAI Agents, and more.
...
* [Agentfield](https://github.com/Agent-Field/agentfield) ⭐ 524 | 🐛 29 | 🌐 Go | 📅 2026-02-06 - Open source Kubernetes-style control plane for deploying AI agents as distributed microservices, with built-in service discovery, durable workflows, and observability.
...
* [Localforge](https://localforge.dev/) – Is an [open source](https://github.com/rockbite/localforge) ⭐ 345 | 🐛 12 | 🌐 JavaScript | 📅 2025-05-18 on-prem AI coding autonomous assistant that lives inside your repo, edits and tests files at SSD speed. Think Claude Code but with UI. plug in any LLM (OpenAI, Gemini, Ollama, etc.) and let it work for you.
...
* [Agentic Signal](https://github.com/code-forge-temple/agentic-signal) ⭐ 99 | 🐛 2 | 🌐 TypeScript | 📅 2026-02-05 - Visual AI agent workflow automation platform with local LLM integration. Build intelligent workflows using drag-and-drop, no cloud required.
...
* [Notebooks](https://github.com/rlan/notebooks) ⭐ 34 | 🐛 4 | 🌐 Dockerfile | 📅 2025-11-17 - A starter kit for Jupyter notebooks and machine learning. Companion docker images consist of all combinations of python versions, machine learning frameworks (Keras, PyTorch and Tensorflow) and CPU/CUDA versions.
* [ScribePal](https://github.com/code-forge-temple/scribe-pal) ⭐ 22 | 🐛 2 | 🌐 TypeScript | 📅 2026-01-28 - Chrome extension that uses local LLMs to assist with writing and drafting responses based on the context of your open tabs.
...
* Some of the python libraries were cut-and-pasted from [vinta](https://github.com/vinta/awesome-python) ⭐ 281,768 | 🐛 15 | 🌐 Python | 📅 2026-02-02
