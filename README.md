...
* For a list of free machine learning books available for download, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/books.md) ⭐ 71,702 | 🐛 14 | 🌐 Python | 📅 2026-01-29.

* For a list of professional machine learning events, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/events.md) ⭐ 71,702 | 🐛 14 | 🌐 Python | 📅 2026-01-29.

* For a list of (mostly) free machine learning courses available online, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/courses.md) ⭐ 71,702 | 🐛 14 | 🌐 Python | 📅 2026-01-29.

* For a list of blogs and newsletters on data science and machine learning, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/blogs.md) ⭐ 71,702 | 🐛 14 | 🌐 Python | 📅 2026-01-29.

* For a list of free-to-attend meetups and local events, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/meetups.md) ⭐ 71,702 | 🐛 14 | 🌐 Python | 📅 2026-01-29.
...
* [Darknet](https://github.com/pjreddie/darknet) ⭐ 26,438 | 🐛 1,977 | 🌐 C | 📅 2024-05-03 - Darknet is an open source neural network framework written in C and CUDA. It is fast, easy to install, and supports CPU and GPU computation.
* [libonnx](https://github.com/xboot/libonnx) ⭐ 648 | 🐛 17 | 🌐 C | 📅 2025-08-05 - A lightweight, portable pure C99 onnx inference engine for embedded devices with hardware acceleration support.
...
* [cONNXr](https://github.com/alrevuelta/cONNXr) ⭐ 216 | 🐛 40 | 🌐 C | 📅 2023-10-29 - An `ONNX` runtime written in pure C (99) with zero dependencies focused on small embedded devices. Run inference on your machine learning models no matter which framework you train it with. Easy to install and compiles everywhere, even in very old devices.
...
* [YOLOv8](https://github.com/ultralytics/ultralytics) ⭐ 53,429 | 🐛 354 | 🌐 Python | 📅 2026-02-19 - Ultralytics' YOLOv8 implementation with C++ support for real-time object detection and tracking, optimized for edge devices.
* [CCV](https://github.com/liuliu/ccv) ⭐ 7,200 | 🐛 78 | 🌐 C++ | 📅 2026-02-19 - C-based/Cached/Core Computer Vision Library, A Modern Computer Vision Library.
...
* [Openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 33,793 | 🐛 358 | 🌐 C++ | 📅 2024-08-03 - A real-time multi-person keypoint detection library for body, face, hands, and foot estimation
...
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,838 | 🐛 1,175 | 🌐 C++ | 📅 2024-07-31 - A deep learning framework developed with cleanliness, readability, and speed in mind. \[DEEP LEARNING]
* [XGBoost](https://github.com/dmlc/xgboost) ⭐ 28,025 | 🐛 477 | 🌐 C++ | 📅 2026-02-19 - A parallelized optimized general purpose gradient boosting library.
...
* [LightGBM](https://github.com/Microsoft/LightGBM) ⭐ 18,092 | 🐛 475 | 🌐 C++ | 📅 2026-02-19 - Microsoft's fast, distributed, high performance gradient boosting (GBDT, GBRT, GBM or MART) framework based on decision tree algorithms, used for ranking, classification and many other machine learning tasks.
* [Opik](https://www.comet.com/site/products/opik/) - Open source engineering platform to debug, evaluate, and monitor your LLM applications, RAG systems, and agentic workflows with comprehensive tracing, automated evaluations, and production-ready dashboards. ([Source Code](https://github.com/comet-ml/opik/) ⭐ 17,787 | 🐛 162 | 🌐 Python | 📅 2026-02-20)
...
* [PyCaret](https://github.com/pycaret/pycaret) ⭐ 9,700 | 🐛 423 | 🌐 Jupyter Notebook | 📅 2025-04-21 - An open-source, low-code machine learning library in Python that automates machine learning workflows.
* [CatBoost](https://github.com/catboost/catboost) ⭐ 8,808 | 🐛 678 | 🌐 C++ | 📅 2026-02-19 - General purpose gradient boosting on decision trees library with categorical features support out of the box. It is easy to install, contains fast inference implementation and supports CPU and GPU (even multi-GPU) computation.
* [Vowpal Wabbit (VW)](https://github.com/VowpalWabbit/vowpal_wabbit) ⭐ 8,658 | 🐛 0 | 🌐 C++ | 📅 2026-02-20 - A fast out-of-core learning system.
...
* [Featuretools](https://github.com/featuretools/featuretools) ⭐ 7,614 | 🐛 163 | 🌐 Python | 📅 2026-02-03 - A library for automated feature engineering. It excels at transforming transactional and relational datasets into feature matrices for machine learning using reusable feature engineering "primitives".
* [Feast](https://github.com/gojek/feast) ⭐ 6,724 | 🐛 268 | 🌐 Python | 📅 2026-02-19 - A feature store for the management, discovery, and access of machine learning features. Feast provides a consistent view of feature data for both model training and model serving.
...
* [Warp-CTC](https://github.com/baidu-research/warp-ctc) ⭐ 4,075 | 🐛 89 | 🌐 Cuda | 📅 2024-03-04 - A fast parallel implementation of Connectionist Temporal Classification (CTC), on both CPU and GPU.
* [oneDNN](https://github.com/oneapi-src/oneDNN) ⭐ 3,959 | 🐛 144 | 🌐 C++ | 📅 2026-02-20 - An open-source cross-platform performance library for deep learning applications.
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,697 | 🐛 123 | 📅 2026-02-16 - A platform for reproducible and scalable machine learning and deep learning.
...
* * [Agentic Context Engine](https://github.com/kayba-ai/agentic-context-engine) ⭐ 1,890 | 🐛 19 | 🌐 Python | 📅 2026-02-19 -In-context learning framework that allows agents to learn from execution feedback.
* [nndeploy](https://github.com/nndeploy/nndeploy) ⭐ 1,744 | 🐛 21 | 🌐 C++ | 📅 2026-02-19 - An Easy-to-Use and High-Performance AI deployment framework.
...
* [Hopsworks](https://github.com/logicalclocks/hopsworks) ⭐ 1,285 | 🐛 16 | 🌐 Java | 📅 2025-02-10 - A data-intensive platform for AI with the industry's first open-source feature store. The Hopsworks Feature Store provides both a feature warehouse for training and batch based on Apache Hive and a feature serving database, based on MySQL Cluster, for online applications.
* [ThunderGBM](https://github.com/Xtra-Computing/thundergbm) ⭐ 711 | 🐛 39 | 🌐 C++ | 📅 2025-03-19 - A fast library for GBDTs and Random Forests on GPUs.
* [Intel® oneAPI Data Analytics Library](https://github.com/oneapi-src/oneDAL) ⭐ 647 | 🐛 68 | 🌐 C++ | 📅 2026-02-19 - A high performance software library developed by Intel and optimized for Intel's architectures. Library provides algorithmic building blocks for all stages of data analytics and allows to process data in batch, online and distributed modes.
...
* [SentencePiece](https://github.com/google/sentencepiece) ⭐ 11,654 | 🐛 25 | 🌐 C++ | 📅 2026-02-11 - A C++ library for unsupervised text tokenization and detokenization, widely used in modern NLP models.
...
* [Kaldi](https://github.com/kaldi-asr/kaldi) ⭐ 15,324 | 🐛 254 | 🌐 Shell | 📅 2025-09-22 - Kaldi is a toolkit for speech recognition written in C++ and licensed under the Apache License v2.0. Kaldi is intended for use by speech recognition researchers.
* [Vosk](https://github.com/alphacep/vosk-api) ⭐ 14,246 | 🐛 585 | 🌐 Jupyter Notebook | 📅 2025-12-08 - An offline speech recognition toolkit with C++ support, designed for low-resource devices and multiple languages.
...
* [RLtools](https://github.com/rl-tools/rl-tools) ⭐ 926 | 🐛 19 | 🌐 C++ | 📅 2026-02-11 - The fastest deep reinforcement learning library for continuous control, implemented header-only in pure, dependency-free C++ (Python bindings available as well).
...
* [mgl](https://github.com/melisgl/mgl/) ⭐ 639 | 🐛 6 | 🌐 Common Lisp | 📅 2025-06-07 - Neural networks (boltzmann machines, feed-forward and recurrent nets), Gaussian Processes.
...
* [tech.ml.dataset](https://github.com/techascent/tech.ml.dataset) ⭐ 737 | 🐛 30 | 🌐 Clojure | 📅 2026-02-10 - Clojure dataframe library and pipeline for data processing and machine learning
...
* [clojupyter](https://github.com/clojupyter/clojupyter) ⭐ 858 | 🐛 13 | 🌐 Clojure | 📅 2025-03-18 -  A Jupyter kernel for Clojure - run Clojure code in Jupyter Lab, Notebook and Console.
...
* [Libpython-clj](https://github.com/clj-python/libpython-clj) ⭐ 1,191 | 🐛 33 | 🌐 Clojure | 📅 2026-01-19 - Interop with Python
...
* [kixistats](https://github.com/MastodonC/kixi.stats) ⭐ 368 | 🐛 1 | 🌐 Clojure | 📅 2025-11-10 - A library of statistical distribution sampling and transducing functions
* [fastmath](https://github.com/generateme/fastmath) ⭐ 276 | 🐛 32 | 🌐 Clojure | 📅 2026-02-16 - A collection of functions for mathematical and statistical computing, macine learning, etc., wrapping several JVM libraries
...
* [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,907 | 🐛 119 | 🌐 Go | 📅 2024-08-12 - Deep learning in Go.
...
* [gogeo](https://github.com/golang/geo) ⭐ 1,820 | 🐛 33 | 🌐 Go | 📅 2026-01-29 - Spherical geometry in Go.
...
* [GoCV](https://github.com/hybridgroup/gocv) ⭐ 7,384 | 🐛 349 | 🌐 Go | 📅 2026-02-18 - Package for computer vision using OpenCV 4 and beyond.

<a name="go-reinforcement-learning"></a>

#### Reinforcement learning

* [stable-baselines3](https://github.com/DLR-RM/stable-baselines3) ⭐ 12,762 | 🐛 79 | 🌐 Python | 📅 2026-02-19 - PyTorch implementations of Stable Baselines (deep) reinforcement learning algorithms.
...
* [H2O](https://github.com/h2oai/h2o-3) ⭐ 7,510 | 🐛 2,876 | 🌐 Jupyter Notebook | 📅 2026-02-20 - ML engine that supports distributed learning on Hadoop, Spark or your laptop via APIs in R, Python, Scala, REST/JSON.
...
* [Mahout](https://github.com/apache/mahout) ⭐ 2,209 | 🐛 67 | 🌐 Rust | 📅 2026-02-19 - Distributed machine learning.
...
* [SystemML](https://github.com/apache/systemml) ⭐ 1,080 | 🐛 79 | 🌐 Java | 📅 2026-02-19 - flexible, scalable machine learning (ML) language.
...
* [rapaio](https://github.com/padreati/rapaio) ⭐ 76 | 🐛 7 | 🌐 Java | 📅 2026-02-16 - statistics, data mining and machine learning toolbox in Java.
* [Chips-n-Salsa](https://github.com/cicirello/Chips-n-Salsa) ⭐ 72 | 🐛 0 | 🌐 Java | 📅 2026-02-16 - A Java library for genetic algorithms, evolutionary computation, and stochastic local search, with a focus on self-adaptation / self-tuning, as well as parallel execution.
...
* [Spark](https://github.com/apache/spark) ⭐ 42,842 | 🐛 256 | 🌐 Scala | 📅 2026-02-20 - Spark is a fast and general engine for large-scale data processing.
* [Hadoop](https://github.com/apache/hadoop) ⭐ 15,486 | 🐛 95 | 🌐 Java | 📅 2026-02-19 - Hadoop/HDFS.
...
* [Deeplearning4j](https://github.com/deeplearning4j/deeplearning4j) ⭐ 14,204 | 🐛 618 | 🌐 Java | 📅 2026-02-16 - Scalable deep learning for industry with parallel GPUs.
* [deepjavalibrary/djl](https://github.com/deepjavalibrary/djl) ⭐ 4,770 | 🐛 220 | 🌐 Java | 📅 2026-02-03 - Deep Java Library (DJL) is an open-source, high-level, engine-agnostic Java framework for deep learning, designed to be easy to get started with and simple to use for Java developers.
...
* [NLP Compromise](https://github.com/spencermountain/compromise) ⭐ 12,032 | 🐛 118 | 🌐 JavaScript | 📅 2025-12-12 - Natural Language processing in the browser.
* [natural](https://github.com/NaturalNode/natural) ⭐ 10,864 | 🐛 80 | 🌐 JavaScript | 📅 2026-02-19 - General natural language facilities for node.
* [nlp.js](https://github.com/axa-group/nlp.js) ⭐ 6,550 | 🐛 116 | 🌐 JavaScript | 📅 2025-01-09 - An NLP library built in node over Natural, with entity extraction, sentiment analysis, automatic language identify, and so more.
* [Knwl.js](https://github.com/loadfive/Knwl.js) ⭐ 5,287 | 🐛 13 | 🌐 JavaScript | 📅 2023-09-28 - A Natural Language Processor in JS.
...
* [cheminfo](https://www.cheminfo.org/) - Platform for data visualization and analysis, using the [visualizer](https://github.com/npellet/visualizer) ⭐ 51 | 🐛 187 | 🌐 JavaScript | 📅 2026-02-14 project.
...
* [Netron](https://github.com/lutzroeder/netron) ⭐ 32,410 | 🐛 21 | 🌐 JavaScript | 📅 2026-02-20 - Visualizer for machine learning models.
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
...
* [Synaptic](https://github.com/cazala/synaptic) ⭐ 6,924 | 🐛 161 | 🌐 JavaScript | 📅 2020-09-03 - Architecture-free neural network library for Node.js and the browser.
* [ml5](https://github.com/ml5js/ml5-library) ⭐ 6,586 | 🐛 288 | 🌐 JavaScript | 📅 2024-10-11 - Friendly machine learning for the web!
* [Keras.js](https://github.com/transcranial/keras-js) ⭐ 4,968 | 🐛 81 | 🌐 JavaScript | 📅 2022-06-15 - Run Keras models in the browser, with GPU support provided by WebGL 2.
...
* [xgboost-node](https://github.com/nuanio/xgboost-node) ⭐ 46 | 🐛 3 | 🌐 Cuda | 📅 2017-10-30 - Run XGBoost model and make predictions in Node.js.
...
* [Creatify MCP](https://github.com/TSavo/creatify-mcp) ⭐ 15 | 🐛 2 | 🌐 TypeScript | 📅 2025-05-26 - Model Context Protocol server that exposes Creatify AI's video generation capabilities to AI assistants, enabling natural language video creation workflows.
...
* [stdlib](https://github.com/stdlib-js/stdlib) ⭐ 5,733 | 🐛 1,165 | 🌐 JavaScript | 📅 2026-02-20 - A standard library for JavaScript and Node.js, with an emphasis on numeric computing. The library provides a collection of robust, high performance libraries for mathematics, statistics, streams, utilities, and more.
* [simple-statistics](https://github.com/simple-statistics/simple-statistics) ⭐ 3,498 | 🐛 25 | 🌐 JavaScript | 📅 2026-02-01 - A JavaScript implementation of descriptive, regression, and inference statistics. Implemented in literate JavaScript with no dependencies, designed to work in all modern browsers (including IE) as well as in Node.js.
* [Pipcook](https://github.com/alibaba/pipcook) ⭐ 2,590 | 🐛 110 | 🌐 TypeScript | 📅 2026-02-20 - A JavaScript application framework for machine learning and its engineering.
...
* [The Bot](https://github.com/sta-ger/TheBot) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2018-07-04 - Example of how the neural network learns to predict the angle between two points created with [Synaptic](https://github.com/cazala/synaptic) ⭐ 6,924 | 🐛 161 | 🌐 JavaScript | 📅 2020-09-03.
* [Half Beer](https://github.com/sta-ger/HalfBeer) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2018-06-26 - Beer glass classifier created with [Synaptic](https://github.com/cazala/synaptic) ⭐ 6,924 | 🐛 161 | 🌐 JavaScript | 📅 2020-09-03.
...
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [MLJ](https://github.com/alan-turing-institute/MLJ.jl) ⭐ 1,893 | 🐛 84 | 🌐 Julia | 📅 2026-02-08 - A Julia machine learning framework.
...
* [GLM](https://github.com/JuliaStats/GLM.jl) ⭐ 633 | 🐛 79 | 🌐 Julia | 📅 2026-02-05 - Generalized linear models in Julia.
...
* [Mixed Models](https://github.com/dmbates/MixedModels.jl) ⭐ 438 | 🐛 56 | 🌐 Julia | 📅 2026-02-03 - A Julia package for fitting (statistical) mixed-effects models.
...
* [XGBoost](https://github.com/dmlc/XGBoost.jl) ⭐ 303 | 🐛 33 | 🌐 Julia | 📅 2025-09-19 - eXtreme Gradient Boosting Package in Julia.
...
* [Kernel Density](https://github.com/JuliaStats/KernelDensity.jl) ⭐ 200 | 🐛 34 | 🌐 Julia | 📅 2026-01-20 - Kernel density estimators for Julia.
...
* [DataFrames](https://github.com/JuliaData/DataFrames.jl) ⭐ 1,812 | 🐛 160 | 🌐 Julia | 📅 2026-01-05 - library for working with tabular data in Julia.
* [Distributions](https://github.com/JuliaStats/Distributions.jl) ⭐ 1,184 | 🐛 465 | 🌐 Julia | 📅 2026-02-16 - A Julia package for probability distributions and associated functions.
...
* [Hypothesis Tests](https://github.com/JuliaStats/HypothesisTests.jl) ⭐ 314 | 🐛 84 | 🌐 Julia | 📅 2025-11-24 - Hypothesis tests for Julia.
...
* [DSP](https://github.com/JuliaDSP/DSP.jl) ⭐ 417 | 🐛 87 | 🌐 Julia | 📅 2026-02-12 - Digital Signal Processing (filtering, periodograms, spectrograms, window functions).
* [SignalProcessing](https://github.com/JuliaDSP/DSP.jl) ⭐ 417 | 🐛 87 | 🌐 Julia | 📅 2026-02-12 - Signal Processing tools for Julia.
...
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,838 | 🐛 1,175 | 🌐 C++ | 📅 2024-07-31 - A deep learning framework developed with cleanliness, readability, and speed in mind.
* [MXNet](https://github.com/apache/incubator-mxnet/) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 86,238 | 🐛 2,723 | 🌐 C++ | 📅 2026-02-18 - A OpenSource Computer Vision Library
...
* [face\_recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,123 | 🐛 833 | 🌐 Python | 📅 2024-08-21 - Face recognition library that recognizes and manipulates faces from Python or from the command line.
* [timm](https://github.com/rwightman/pytorch-image-models) ⭐ 36,383 | 🐛 65 | 🌐 Python | 📅 2026-02-18 - PyTorch image models, scripts, pretrained weights -- ResNet, ResNeXT, EfficientNet, EfficientNetV2, NFNet, Vision Transformer, MixNet, MobileNet-V3/V2, RegNet, DPN, CSPNet, and more.
* [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,085 | 🐛 589 | 🌐 Python | 📅 2025-11-17 - FAIR's next-generation research platform for object detection and segmentation. It is a ground-up rewrite of the previous version, Detectron, and is powered by the PyTorch deep learning framework.
* [Openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 33,793 | 🐛 358 | 🌐 C++ | 📅 2024-08-03 - A real-time multi-person keypoint detection library for body, face, hands, and foot estimation
...
* [MLX](https://github.com/ml-explore/mlx) ⭐ 23,986 | 🐛 169 | 🌐 C++ | 📅 2026-02-19- MLX is an array framework for machine learning on Apple silicon, developed by Apple machine learning research.
* [deepface](https://github.com/serengil/deepface) ⭐ 22,226 | 🐛 6 | 🌐 Python | 📅 2026-02-10 - A lightweight face recognition and facial attribute analysis (age, gender, emotion and race) framework for Python covering cutting-edge models such as VGG-Face, FaceNet, OpenFace, DeepFace, DeepID, Dlib and ArcFace.
...
* [segmentation\_models.pytorch](https://github.com/qubvel/segmentation_models.pytorch) ⭐ 11,337 | 🐛 88 | 🌐 Python | 📅 2025-12-23 - A PyTorch-based toolkit that offers pre-trained segmentation models for computer vision tasks. It simplifies the development of image segmentation applications by providing a collection of popular architecture implementations, such as UNet and PSPNet, along with pre-trained weights, making it easier for researchers and developers to achieve high-quality pixel-level object segmentation in images.
* [Exadel CompreFace](https://github.com/exadel-inc/CompreFace) ⭐ 7,782 | 🐛 232 | 🌐 Java | 📅 2024-10-05 - face recognition system that can be easily integrated into any system without prior machine learning skills. CompreFace provides REST API for face recognition, face verification, face detection, face mask detection, landmark detection, age, and gender recognition and is easily deployed with docker.
* [Scikit-Image](https://github.com/scikit-image/scikit-image) ⭐ 6,455 | 🐛 870 | 🌐 Python | 📅 2026-02-18 - A collection of algorithms for image processing in Python.
* [Scikit-Opt](https://github.com/guofei9987/scikit-opt) ⭐ 6,371 | 🐛 70 | 🌐 Python | 📅 2025-08-31 - Swarm Intelligence in Python (Genetic Algorithm, Particle Swarm Optimization, Simulated Annealing, Ant Colony Algorithm, Immune Algorithm, Artificial Fish Swarm Algorithm in Python)
* [pytessarct](https://github.com/madmaze/pytesseract) ⭐ 6,314 | 🐛 18 | 🌐 Python | 📅 2026-01-19 - Python-tesseract is an optical character recognition (OCR) tool for python. That is, it will recognize and "read" the text embedded in images. Python-tesseract is a wrapper for [Google's Tesseract-OCR Engine](https://github.com/tesseract-ocr/tesseract) ⭐ 72,459 | 🐛 467 | 🌐 C++ | 📅 2026-02-13.
* [segmentation\_models](https://github.com/qubvel/segmentation_models) ⭐ 4,918 | 🐛 274 | 🌐 Python | 📅 2024-08-21 - A TensorFlow Keras-based toolkit that offers pre-trained segmentation models for computer vision tasks. It simplifies the development of image segmentation applications by providing a collection of popular architecture implementations, such as UNet and PSPNet, along with pre-trained weights, making it easier for researchers and developers to achieve high-quality pixel-level object segmentation in images.
...
* [lightly](https://github.com/lightly-ai/lightly) ⭐ 3,681 | 🐛 83 | 🌐 Python | 📅 2026-02-19 - Lightly is a computer vision framework for self-supervised learning.
* [computer-vision-in-action](https://github.com/Charmve/computer-vision-in-action) ⭐ 2,832 | 🐛 60 | 🌐 Jupyter Notebook | 📅 2024-05-27 - as known as `L0CV`, is a new generation of computer vision open source online learning media, a cross-platform interactive learning framework integrating graphics, source code and HTML. the L0CV ecosystem — Notebook, Datasets, Source Code, and from Diving-in to Advanced — as well as the L0CV Hub.
* [PCV](https://github.com/jesolem/PCV) ⭐ 1,958 | 🐛 26 | 🌐 Python | 📅 2020-12-28 - Open source Python module for computer vision. **\[Deprecated]**
* [retinaface](https://github.com/serengil/retinaface) ⭐ 1,908 | 🐛 1 | 🌐 Python | 📅 2025-08-11 - deep learning based cutting-edge facial detector for Python coming with facial landmarks
* [LightlyTrain](https://github.com/lightly-ai/lightly-train) ⭐ 1,320 | 🐛 50 | 🌐 Python | 📅 2026-02-19 - Pretrain computer vision models on unlabeled data for industrial applications
* [TF-GAN](https://github.com/tensorflow/gan) ⭐ 968 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2025-01-16 - TF-GAN is a lightweight library for training and evaluating Generative Adversarial Networks (GANs).
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 156,732 | 🐛 2,282 | 🌐 Python | 📅 2026-02-20 - A deep learning library containing thousands of pre-trained models on different tasks. The goto place for anything related to Large Language Models.
* [jieba](https://github.com/fxsjy/jieba#jieba-1) ⭐ 34,764 | 🐛 697 | 🌐 Python | 📅 2024-08-21 - Chinese Words Segmentation Utilities.
* [spaCy](https://github.com/explosion/spaCy) ⭐ 33,221 | 🐛 189 | 🌐 Python | 📅 2025-11-27 - Industrial strength NLP with Python and Cython.
* [Haystack](https://github.com/deepset-ai/haystack) ⭐ 24,240 | 🐛 107 | 🌐 MDX | 📅 2026-02-19 - A framework for building industrial-strength applications with Transformer models and LLMs.
* [Rasa](https://github.com/RasaHQ/rasa) ⭐ 21,054 | 🐛 145 | 🌐 Python | 📅 2026-01-29 - A "machine learning framework to automate text-and voice-based conversations."
* [CometLLM](https://github.com/comet-ml/comet-llm) ⭐ 17,787 | 🐛 162 | 🌐 Python | 📅 2026-02-20 - Track, log, visualize and evaluate your LLM prompts and prompt chains.
...
* [pkuseg-python](https://github.com/lancopku/pkuseg-python) ⭐ 6,699 | 🐛 135 | 🌐 Python | 📅 2022-11-05 - A better version of Jieba, developed by Peking University.
...
* [Dedupe](https://github.com/dedupeio/dedupe) ⭐ 4,442 | 🐛 88 | 🌐 Python | 📅 2025-07-29 - A python library for accurate and scalable fuzzy matching, record deduplication and entity-resolution.
* [Snips NLU](https://github.com/snipsco/snips-nlu) ⭐ 3,958 | 🐛 67 | 🌐 Python | 📅 2023-05-22 - Natural Language Understanding library for intent classification and entity extraction
* [Polyglot](https://github.com/aboSamoor/polyglot) ⭐ 2,362 | 🐛 170 | 🌐 Python | 📅 2023-11-10 - Multilingual text (NLP) processing toolkit.
* [textacy](https://github.com/chartbeat-labs/textacy) ⭐ 2,233 | 🐛 35 | 🌐 Python | 📅 2023-09-22 - higher-level NLP built on Spacy.
* [jellyfish](https://github.com/jamesturk/jellyfish) ⭐ 2,191 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2025-12-15 - a python library for doing approximate and phonetic matching of strings.
...
* [CLTK](https://github.com/cltk/cltk) ⭐ 894 | 🐛 5 | 🌐 Python | 📅 2026-02-12 - The Classical Language Toolkit.
* [NobodyWho](https://github.com/nobodywho-ooo/nobodywho) ⭐ 705 | 🐛 38 | 🌐 Rust | 📅 2026-02-19 - The simplest way to run an LLM locally. Supports tool calling and grammar constrained sampling.
...
* [VeritasGraph](https://github.com/bibinprathap/VeritasGraph) ⭐ 241 | 🐛 0 | 📅 2026-02-03 - Enterprise-Grade Graph RAG for Secure, On-Premise AI with Verifiable Attribution.
...
* [TensorFlow](https://github.com/tensorflow/tensorflow/) ⭐ 193,866 | 🐛 3,588 | 🌐 C++ | 📅 2026-02-20 - Open source software library for numerical computation using data flow graphs.
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 97,607 | 🐛 17,971 | 🌐 Python | 📅 2026-02-20 - Tensors and Dynamic neural networks in Python with strong GPU acceleration
* [keras](https://github.com/keras-team/keras) ⭐ 63,858 | 🐛 279 | 🌐 Python | 📅 2026-02-20 - High-level neural networks frontend for [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 193,866 | 🐛 3,588 | 🌐 C++ | 📅 2026-02-20, [CNTK](https://github.com/Microsoft/CNTK) ⚠️ Archived and [Theano](https://github.com/Theano/Theano) ⭐ 9,986 | 🐛 698 | 🌐 Python | 📅 2024-01-15.
* [Streamlit](https://github.com/streamlit/streamlit) ⭐ 43,546 | 🐛 1,326 | 🌐 Python | 📅 2026-02-20: Streamlit is an framework to create beautiful data apps in hours, not weeks.
* [Gradio](https://github.com/gradio-app/gradio) ⭐ 41,758 | 🐛 470 | 🌐 Python | 📅 2026-02-20 - A Python library for quickly creating and sharing demos of models. Debug models interactively in your browser, get feedback from collaborators, and generate public links without deploying anything.
* [Colossal-AI](https://github.com/hpcaitech/ColossalAI) ⭐ 41,349 | 🐛 493 | 🌐 Python | 📅 2026-01-19: An open-source deep learning system for large-scale model training and inference with high efficiency and low cost.
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 38,530 | 🐛 176 | 🌐 Python | 📅 2026-02-19 - Open Source framework to streamline use of neural networks.
* [JAX](https://github.com/google/jax) ⭐ 34,909 | 🐛 2,221 | 🌐 Python | 📅 2026-02-20 - JAX is Autograd and XLA, brought together for high-performance machine learning research.
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,838 | 🐛 1,175 | 🌐 C++ | 📅 2024-07-31 - A deep learning framework developed with cleanliness, readability, and speed in mind.
* [PyTorch Lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 30,852 | 🐛 952 | 🌐 Python | 📅 2026-02-16 - The lightweight PyTorch wrapper for high-performance AI research.
* [ML-From-Scratch](https://github.com/eriklindernoren/ML-From-Scratch) ⭐ 30,849 | 🐛 71 | 🌐 Python | 📅 2023-10-15 - Implementations of Machine Learning models from scratch in Python with a focus on transparency. Aims to showcase the nuts and bolts of ML in an accessible way.
* [Bayesian Methods for Hackers](https://github.com/CamDavidsonPilon/Probabilistic-Programming-and-Bayesian-Methods-for-Hackers) ⭐ 28,482 | 🐛 204 | 🌐 Jupyter Notebook | 📅 2024-06-25 - Book/iPython notebooks on Probabilistic Programming in Python.
* [XGBoost](https://github.com/dmlc/xgboost) ⭐ 28,025 | 🐛 477 | 🌐 C++ | 📅 2026-02-19 - Python bindings for eXtreme Gradient Boosting (Tree) Library.
* [Fastai](https://github.com/fastai/fastai) ⭐ 27,858 | 🐛 265 | 🌐 Jupyter Notebook | 📅 2026-02-14 - High-level wrapper built on the top of Pytorch which supports vision, text, tabular data and collaborative filtering.
* [PyTorch Geometric](https://github.com/pyg-team/pytorch_geometric) ⭐ 23,484 | 🐛 1,248 | 🌐 Python | 📅 2026-02-19 -> Graph Neural Network Library for PyTorch.
...
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [Opik](https://github.com/comet-ml/opik) ⭐ 17,787 | 🐛 162 | 🌐 Python | 📅 2026-02-20: Evaluate, trace, test, and ship LLM applications across your dev and production lifecycles.
...
* [Neural Networks and Deep Learning](https://github.com/mnielsen/neural-networks-and-deep-learning) ⭐ 17,453 | 🐛 7 | 🌐 Python | 📅 2024-06-02 - Code samples for my book "Neural Networks and Deep Learning" \[DEEP LEARNING].
* [gensim](https://github.com/RaRe-Technologies/gensim) ⭐ 16,359 | 🐛 434 | 🌐 Python | 📅 2025-11-01 - Topic Modelling for Humans.
* [numpy-ML](https://github.com/ddbourgin/numpy-ml) ⭐ 16,275 | 🐛 40 | 🌐 Python | 📅 2023-10-29: Reference implementations of ML models written in numpy
* [Annoy](https://github.com/spotify/annoy) ⭐ 14,156 | 🐛 75 | 🌐 C++ | 📅 2025-10-29 - Approximate nearest neighbours implementation.
* [Optuna](https://github.com/optuna/optuna) ⭐ 13,545 | 🐛 34 | 🌐 Python | 📅 2026-02-18: Optuna is an automatic hyperparameter optimization software framework, particularly designed for machine learning.
* [cleanlab](https://github.com/cleanlab/cleanlab) ⭐ 11,326 | 🐛 100 | 🌐 Python | 📅 2026-01-13: The standard data-centric AI package for data quality and machine learning with messy, real-world data and labels.
...
* [AutoGluon](https://github.com/awslabs/autogluon) ⭐ 9,997 | 🐛 386 | 🌐 Python | 📅 2026-02-19: AutoML for Image, Text, Tabular, Time-Series, and MultiModal Data.
...
* [PySyft](https://github.com/OpenMined/PySyft) ⭐ 9,854 | 🐛 65 | 🌐 Python | 📅 2025-07-15 - A Python library for secure and private Deep Learning built on PyTorch and TensorFlow.
* [PyOD](https://github.com/yzhao062/pyod) ⭐ 9,718 | 🐛 240 | 🌐 Python | 📅 2026-01-05 -> Python Outlier Detection, comprehensive and scalable Python toolkit for detecting outlying objects in multivariate data. Featured for Advanced models, including Neural Networks/Deep Learning and Outlier Ensembles.
* [TFLearn](https://github.com/tflearn/tflearn) ⭐ 9,606 | 🐛 579 | 🌐 Python | 📅 2024-05-06 - Deep learning library featuring a higher-level API for TensorFlow.
* [sktime](https://github.com/alan-turing-institute/sktime) ⭐ 9,515 | 🐛 1,789 | 🌐 Python | 📅 2026-02-17 - A unified framework for machine learning with time series
* [einops](https://github.com/arogozhnikov/einops) ⭐ 9,396 | 🐛 33 | 🌐 Python | 📅 2026-02-20 - Deep learning operations reinvented (for pytorch, tensorflow, jax and others).
* [Hub](https://github.com/activeloopai/Hub) ⭐ 9,006 | 🐛 62 | 🌐 C++ | 📅 2026-02-16 - Fastest unstructured dataset management for TensorFlow/PyTorch. Stream & version-control data. Store even petabyte-scale data in a single numpy-like array on the cloud accessible on any machine. Visit [activeloop.ai](https://activeloop.ai) for more info.
* [pattern](https://github.com/clips/pattern) ⭐ 8,853 | 🐛 176 | 🌐 Python | 📅 2024-06-10 - Web mining module for Python.
* [CatBoost](https://github.com/catboost/catboost) ⭐ 8,808 | 🐛 678 | 🌐 C++ | 📅 2026-02-19 - General purpose gradient boosting on decision trees library with categorical features support out of the box. It is easy to install, well documented and supports CPU and GPU (even multi-GPU) computation.
* [BentoML](https://github.com/bentoml/bentoml) ⭐ 8,456 | 🐛 139 | 🌐 Python | 📅 2026-02-11: Toolkit for package and deploy machine learning models for serving in production
* [Cortex](https://github.com/cortexlabs/cortex) ⭐ 8,031 | 🐛 131 | 🌐 Go | 📅 2024-06-12 - Open source platform for deploying machine learning models in production.
...
* [InterpretML](https://github.com/interpretml/interpret) ⭐ 6,797 | 🐛 112 | 🌐 C++ | 📅 2026-02-20 - InterpretML implements the Explainable Boosting Machine (EBM), a modern, fully interpretable machine learning model based on Generalized Additive Models (GAMs). This open-source package also provides visualization tools for EBMs, other glass-box models, and black-box explanations.
* [NuPIC](https://github.com/numenta/nupic) ⭐ 6,360 | 🐛 464 | 🌐 Python | 📅 2024-12-03 - Numenta Platform for Intelligent Computing.
* [deap](https://github.com/deap/deap) ⭐ 6,336 | 🐛 285 | 🌐 Python | 📅 2025-11-16 - Evolutionary algorithm framework.
* [skorch](https://github.com/skorch-dev/skorch) ⭐ 6,151 | 🐛 70 | 🌐 Jupyter Notebook | 📅 2026-02-16 - A scikit-learn compatible neural network library that wraps PyTorch.
* [Aim](https://github.com/aimhubio/aim) ⭐ 6,001 | 🐛 451 | 🌐 Python | 📅 2026-02-19 -> An easy-to-use & supercharged open-source AI metadata tracker.
* [Chainer](https://github.com/chainer/chainer) ⭐ 5,923 | 🐛 12 | 🌐 Python | 📅 2023-08-28 - Flexible neural network framework.
* [River](https://github.com/online-ml/river) ⭐ 5,721 | 🐛 117 | 🌐 Python | 📅 2026-02-09: A framework for general purpose online machine learning.
* [Microsoft ML for Apache Spark](https://github.com/Azure/mmlspark) ⭐ 5,199 | 🐛 378 | 🌐 Scala | 📅 2026-02-14 -> A distributed machine learning framework Apache Spark
* [mlxtend](https://github.com/rasbt/mlxtend) ⭐ 5,114 | 🐛 156 | 🌐 Python | 📅 2026-01-24 - A library consisting of useful tools for data science and machine learning tasks.
...
* [Deepchecks](https://github.com/deepchecks/deepchecks) ⭐ 3,979 | 🐛 258 | 🌐 Python | 📅 2025-12-28: Validation & testing of machine learning models and data during model development, deployment, and production. This includes checks and suites related to various types of issues, such as model performance, data integrity, distribution mismatches, and more.
...
* [pomegranate](https://github.com/jmschrei/pomegranate) ⭐ 3,505 | 🐛 41 | 🌐 Python | 📅 2025-03-06 - Hidden Markov Models for Python, implemented in Cython for speed and efficiency.
...
* [Determined](https://github.com/determined-ai/determined) ⭐ 3,213 | 🐛 105 | 🌐 Go | 📅 2025-03-20 - Scalable deep learning training platform, including integrated support for distributed training, hyperparameter tuning, experiment tracking, and model management.
* [PyBroker](https://github.com/edtechre/pybroker) ⭐ 3,193 | 🐛 4 | 🌐 Python | 📅 2026-02-03 - Algorithmic Trading with Machine Learning.
* [pgmpy](https://github.com/pgmpy/pgmpy) ⭐ 3,155 | 🐛 438 | 🌐 Python | 📅 2026-02-19 A python library for working with Probabilistic Graphical Models.
* [Shapash](https://github.com/MAIF/shapash) ⭐ 3,148 | 🐛 46 | 🌐 Jupyter Notebook | 📅 2026-02-06 : Shapash is a Python library that provides several types of visualization that display explicit labels that everyone can understand.
* [igel](https://github.com/nidhaloff/igel) ⭐ 3,138 | 🐛 19 | 🌐 Python | 📅 2025-12-07 -> A delightful machine learning tool that allows you to train/fit, test and use models **without writing code**
...
* [PyTorch Geometric Temporal](https://github.com/benedekrozemberczki/pytorch_geometric_temporal) ⭐ 2,945 | 🐛 29 | 🌐 Python | 📅 2025-09-18 -> A temporal extension of PyTorch Geometric for dynamic graph representation learning.
* [PyBrain](https://github.com/pybrain/pybrain) ⭐ 2,867 | 🐛 156 | 🌐 Python | 📅 2024-06-27 - Another Python Machine Learning Library.
* [Pylearn2](https://github.com/lisa-lab/pylearn2) ⭐ 2,776 | 🐛 201 | 🌐 Python | 📅 2021-08-20 - A Machine Learning library based on [Theano](https://github.com/Theano/Theano) ⭐ 9,986 | 🐛 698 | 🌐 Python | 📅 2024-01-15. **\[Deprecated]**
* [modAL](https://github.com/modAL-python/modAL) ⭐ 2,338 | 🐛 108 | 🌐 Python | 📅 2024-02-26 - A modular active learning framework for Python, built on top of scikit-learn.
...
* [skrub](https://github.com/skrub-data/skrub) ⭐ 1,567 | 🐛 150 | 🌐 Python | 📅 2026-02-19 - Skrub is a Python library that eases preprocessing and feature engineering for machine learning on dataframes.
...
* [skforecast](https://github.com/skforecast/skforecast) ⭐ 1,444 | 🐛 19 | 🌐 Python | 📅 2026-02-19 - Python library for time series forecasting using machine learning models. It works with any regressor compatible with the scikit-learn API, including popular options like LightGBM, XGBoost, CatBoost, Keras, and many others.
* [metric-learn](https://github.com/metric-learn/metric-learn) ⭐ 1,430 | 🐛 52 | 🌐 Python | 📅 2024-08-03 - A Python module for metric learning.
* [pydeep](https://github.com/andersbll/deeppy) ⭐ 1,379 | 🐛 22 | 🌐 Python | 📅 2020-12-28 - Deep Learning In Python. **\[Deprecated]**
* [nilearn](https://github.com/nilearn/nilearn) ⭐ 1,364 | 🐛 305 | 🌐 Python | 📅 2026-02-20 - Machine learning for NeuroImaging in Python.
* [MCP Memory Service](https://github.com/doobidoo/mcp-memory-service) ⭐ 1,352 | 🐛 4 | 🌐 Python | 📅 2026-02-19 - Universal memory service with semantic search, autonomous consolidation, and multi-client support for AI applications.
* [Intel(R) Extension for Scikit-learn](https://github.com/intel/scikit-learn-intelex) ⭐ 1,331 | 🐛 81 | 🌐 Python | 📅 2026-02-19 - A seamless way to speed up your Scikit-learn applications with no accuracy loss and code changes.
...
* [dtaidistance](https://github.com/wannesm/dtaidistance) ⭐ 1,215 | 🐛 21 | 🌐 Python | 📅 2026-02-12 - High performance library for time series distances (DTW) and time series clustering.
...
* [scikit-multiflow](https://github.com/scikit-multiflow/scikit-multiflow) ⭐ 792 | 🐛 73 | 🌐 Python | 📅 2023-11-02 - A machine learning framework for multi-output/multi-label and stream data.
...
* [Opytimizer](https://github.com/gugarosa/opytimizer) ⭐ 630 | 🐛 0 | 🌐 Python | 📅 2026-02-16 - Python-based meta-heuristic optimization techniques.
...
* [Lightwood](https://github.com/mindsdb/lightwood) ⭐ 502 | 🐛 16 | 🌐 Python | 📅 2026-02-11 - A Pytorch based framework that breaks down machine learning problems into smaller blocks that can be glued together seamlessly with objective to build predictive models with one line of code.
...
* [CometML](https://github.com/comet-ml/comet-examples) ⭐ 171 | 🐛 27 | 🌐 Jupyter Notebook | 📅 2026-02-09: The best-in-class MLOps platform with experiment tracking, model production monitoring, a model registry, and data lineage from training straight through to production.
...
* [Neurolink](https://github.com/juspay/neurolink) ⭐ 105 | 🐛 422 | 🌐 TypeScript | 📅 2026-02-19 - Enterprise-grade LLM integration framework for building production-ready AI applications with built-in hallucination prevention, RAG, and MCP support.
...
* [Superset](https://github.com/apache/incubator-superset) ⭐ 70,587 | 🐛 1,142 | 🌐 TypeScript | 📅 2026-02-20 - A data exploration platform designed to be visual, intuitive, and interactive.
* [Dash](https://github.com/plotly/dash) ⭐ 24,500 | 🐛 562 | 🌐 Python | 📅 2026-02-18 - A framework for creating analytical web applications built on top of Plotly.js, React, and Flask
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,355 | 🐛 869 | 🌐 TypeScript | 📅 2026-02-19 - Interactive Web Plotting for Python.
* [zipline](https://github.com/quantopian/zipline) ⭐ 19,428 | 🐛 367 | 🌐 Python | 📅 2024-02-13 - A Pythonic algorithmic trading library.
* [SymPy](https://github.com/sympy/sympy) ⭐ 14,393 | 🐛 5,564 | 🌐 Python | 📅 2026-02-19 - A Python library for symbolic mathematics.
...
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,258 | 🐛 2,970 | 🌐 Python | 📅 2026-01-13 - Statistical modelling and econometrics in Python.
* [altair](https://github.com/altair-viz/altair) ⭐ 10,265 | 🐛 156 | 🌐 Python | 📅 2026-02-19 - A Python to Vega translator.
* [PyMC](https://github.com/pymc-devs/pymc) ⭐ 9,486 | 🐛 466 | 🌐 Python | 📅 2026-02-16 - Markov Chain Monte Carlo sampling toolkit.
* [Vaex](https://github.com/vaexio/vaex) ⭐ 8,471 | 🐛 548 | 🌐 Python | 📅 2026-02-05 - A high performance Python library for lazy Out-of-Core DataFrames (similar to Pandas), to visualize and explore big tabular datasets. Documentation can be found [here](https://vaex.io/docs/index.html).
* [PyQtGraph](https://github.com/pyqtgraph/pyqtgraph) ⭐ 4,298 | 🐛 500 | 🌐 Python | 📅 2026-02-13 - A pure-python graphics and GUI library built on PyQt4 / PySide and NumPy.
* [ggplot](https://github.com/yhat/ggpy) ⭐ 3,698 | 🐛 178 | 🌐 Python | 📅 2023-01-21 - Same API as ggplot2 for R. **\[Deprecated]**
* [bqplot](https://github.com/bloomberg/bqplot) ⭐ 3,683 | 🐛 278 | 🌐 TypeScript | 📅 2026-01-23 - An API for plotting in Jupyter (IPython).
* [vispy](https://github.com/vispy/vispy) ⭐ 3,546 | 🐛 377 | 🌐 Python | 📅 2026-01-14 - GPU-based high-performance interactive OpenGL 2D/3D data visualization library.
...
* [Mars](https://github.com/mars-project/mars) ⭐ 2,749 | 🐛 215 | 🌐 Python | 📅 2024-01-02 - A tensor-based framework for large-scale data computation which is often regarded as a parallel and distributed version of NumPy.
* [scikit-plot](https://github.com/reiinakano/scikit-plot) ⭐ 2,431 | 🐛 31 | 🌐 Python | 📅 2024-08-20 - A visualization library for quick and easy generation of common plots in data analysis and machine learning.
...
* [emcee](https://github.com/dfm/emcee) ⭐ 1,567 | 🐛 67 | 🌐 Python | 📅 2026-01-19 - The Python ensemble sampling toolkit for affine-invariant MCMC.
* [PyCM](https://github.com/sepandhaghighi/pycm) ⭐ 1,500 | 🐛 13 | 🌐 Python | 📅 2026-02-19 - PyCM is a multi-class confusion matrix library written in Python that supports both input data vectors and direct matrix, and a proper tool for post-classification model evaluation that supports most classes and overall statistics parameters
...
* [DataComPy](https://github.com/capitalone/datacompy) ⭐ 633 | 🐛 12 | 🌐 Python | 📅 2026-02-12 - A library to compare Pandas, Polars, and Spark data frames. It provides stats and lets users adjust for match accuracy.
...
* [data-science-ipython-notebooks](https://github.com/donnemartin/data-science-ipython-notebooks) ⭐ 28,877 | 🐛 42 | 🌐 Python | 📅 2024-03-20 - Continually updated Data Science Python Notebooks: Spark, Hadoop MapReduce, HDFS, AWS, Kaggle, scikit-learn, matplotlib, pandas, NumPy, SciPy, and various command lines.
* [handsonml](https://github.com/ageron/handson-ml) ⭐ 25,873 | 🐛 145 | 🌐 Jupyter Notebook | 📅 2023-10-03 - Fundamentals of machine learning in python.
* [Pydata book](https://github.com/wesm/pydata-book) ⭐ 24,312 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2025-10-17 - Materials and IPython notebooks for "Python for Data Analysis" by Wes McKinney, published by O'Reilly Media
* [Homemade Machine Learning](https://github.com/trekhleb/homemade-machine-learning) ⭐ 24,261 | 🐛 28 | 🌐 Jupyter Notebook | 📅 2025-11-23 - Python examples of popular machine learning algorithms with interactive Jupyter demos and math being explained
...
* [Introduction to Machine Learning with Python](https://github.com/amueller/introduction_to_ml_with_python) ⭐ 8,024 | 🐛 28 | 🌐 Jupyter Notebook | 📅 2024-03-14 - Notebooks and code for the book "Introduction to Machine Learning with Python"
* [pandas cookbook](https://github.com/jvns/pandas-cookbook) ⭐ 7,028 | 🐛 34 | 🌐 Jupyter Notebook | 📅 2024-10-24 - Recipes for using Python's pandas library.
* [numpic](https://github.com/numenta/nupic) ⭐ 6,360 | 🐛 464 | 🌐 Python | 📅 2024-12-03
...
* [Hyperparameter-Optimization-of-Machine-Learning-Algorithms](https://github.com/LiYangHart/Hyperparameter-Optimization-of-Machine-Learning-Algorithms) ⭐ 1,320 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2022-09-22 - Code for hyperparameter tuning/optimization of machine learning and deep learning algorithms.
...
* [NeuralTalk](https://github.com/karpathy/neuraltalk2) ⭐ 5,572 | 🐛 142 | 🌐 Jupyter Notebook | 📅 2017-11-07 - NeuralTalk is a Python+numpy project for learning Multimodal Recurrent Neural Networks that describe images with sentences. **\[Deprecated]**
...
* [Tonic](https://github.com/neuromorphs/tonic) ⭐ 270 | 🐛 33 | 🌐 Python | 📅 2025-10-23 - A library that makes downloading publicly available neuromorphic datasets a breeze and provides event-based data transformation/augmentation pipelines.
* [Sinabs](https://github.com/synsense/sinabs) ⭐ 110 | 🐛 27 | 🌐 Python | 📅 2026-02-05 - A deep learning library for spiking neural networks which is based on PyTorch, focuses on fast training and supports inference on neuromorphic hardware.
* [Rockpool](https://github.com/synsense/rockpool) ⭐ 77 | 🐛 2 | 🌐 Python | 📅 2026-02-10 - A machine learning library for spiking neural networks. Supports training with both torch and jax pipelines, and deployment to neuromorphic hardware.

<a name="python-survival-analysis"></a>

#### Python Survival Analysis

* [lifelines](https://github.com/CamDavidsonPilon/lifelines) ⭐ 2,550 | 🐛 278 | 🌐 Python | 📅 2026-02-04 - lifelines is a complete survival analysis library, written in pure Python
* [Scikit-Survival](https://github.com/sebp/scikit-survival) ⭐ 1,269 | 🐛 29 | 🌐 Python | 📅 2026-02-16 - scikit-survival is a Python module for survival analysis built on top of scikit-learn. It allows doing survival analysis while utilizing the power of scikit-learn, e.g., for pre-processing or doing cross-validation.
...
* [PySyft](https://github.com/OpenMined/PySyft) ⭐ 9,854 | 🐛 65 | 🌐 Python | 📅 2025-07-15 - A Python library for secure and private Deep Learning.
...
* [RLlib](https://github.com/ray-project/ray) ⭐ 41,403 | 🐛 3,378 | 🌐 Python | 📅 2026-02-20 - RLlib is an industry level, highly scalable RL library for tf and torch, based on Ray. It's used by companies like Amazon and Microsoft to solve real-world decision making problems at scale.
* [Gymnasium](https://github.com/Farama-Foundation/Gymnasium) ⭐ 11,349 | 🐛 82 | 🌐 Python | 📅 2026-02-19 - A library for developing and comparing reinforcement learning algorithms (successor of \[gym])(<https://github.com/openai/gym> ⭐ 37,053 | 🐛 127 | 🌐 Python | 📅 2024-10-11).
* [DeepMind Lab](https://github.com/deepmind/lab) ⭐ 7,328 | 🐛 66 | 🌐 C | 📅 2023-01-04 - DeepMind Lab is a 3D learning environment based on id Software's Quake III Arena via ioquake3 and other open source software. Its primary purpose is to act as a testbed for research in artificial intelligence, especially deep reinforcement learning.
...
* [DI-engine](https://github.com/opendilab/DI-engine) ⭐ 3,593 | 🐛 25 | 🌐 Python | 📅 2025-12-07 - DI-engine is a generalized Decision Intelligence engine. It supports most basic deep reinforcement learning (DRL) algorithms, such as DQN, PPO, SAC, and domain-specific algorithms like QMIX in multi-agent RL, GAIL in inverse RL, and RND in exploration problems.
...
* [garage](https://github.com/rlworkgroup/garage) ⭐ 2,081 | 🐛 234 | 🌐 Python | 📅 2023-05-04 - A toolkit for reproducible reinforcement learning research
* [ViZDoom](https://github.com/mwydmuch/ViZDoom) ⭐ 1,976 | 🐛 30 | 🌐 C++ | 📅 2026-02-11 - ViZDoom allows developing AI bots that play Doom using only the visual information (the screen buffer). It is primarily intended for research in machine visual learning, and deep reinforcement learning, in particular.
* [metaworld](https://github.com/rlworkgroup/metaworld) ⭐ 1,746 | 🐛 8 | 🌐 Python | 📅 2026-01-20 - An open source robotics benchmark for meta- and multi-task reinforcement learning
* [SLM Lab](https://github.com/kengz/SLM-Lab) ⭐ 1,334 | 🐛 8 | 🌐 Python | 📅 2026-02-20 - Modular Deep Reinforcement Learning framework in PyTorch.
* [Maze](https://github.com/enlite-ai/maze) ⭐ 286 | 🐛 2 | 🌐 Python | 📅 2026-02-18 - Application-oriented deep reinforcement learning framework addressing real-world decision problems.
...
* [EspNet](https://github.com/espnet/espnet) ⭐ 9,742 | 🐛 54 | 🌐 Python | 📅 2026-02-19 - ESPnet is an end-to-end speech processing toolkit for tasks like speech recognition, translation, and enhancement, using PyTorch and Kaldi-style data processing.
...
* [rumale](https://github.com/yoshoku/rumale) ⭐ 901 | 🐛 0 | 🌐 Ruby | 📅 2026-02-19 - Rumale is a machine learning library in Ruby
...
* [candle](https://github.com/huggingface/candle) ⭐ 19,422 | 🐛 604 | 🌐 Rust | 📅 2026-02-19 - Candle is a minimalist ML framework for Rust with a focus on performance (including GPU support) and ease of use.
...
* [linfa](https://github.com/rust-ml/linfa) ⭐ 4,555 | 🐛 67 | 🌐 Rust | 📅 2026-02-04 - a comprehensive toolkit to build Machine Learning applications with Rust
* [linfa](https://github.com/rust-ml/linfa) ⭐ 4,555 | 🐛 67 | 🌐 Rust | 📅 2026-02-04 - `linfa` aims to provide a comprehensive toolkit to build Machine Learning applications with Rust
...
* [burn](https://github.com/tracel-ai/burn) ⭐ 14,396 | 🐛 228 | 🌐 Rust | 📅 2026-02-19 - Burn is a new comprehensive dynamic Deep Learning Framework built using Rust with extreme flexibility, compute efficiency and portability as its primary goals
* [tch-rs](https://github.com/LaurentMazare/tch-rs) ⭐ 5,286 | 🐛 227 | 🌐 Rust | 📅 2026-01-22 - Rust bindings for the C++ API of PyTorch
...
* [huggingface/tokenizers](https://github.com/huggingface/tokenizers) ⭐ 10,479 | 🐛 144 | 🌐 Rust | 📅 2026-02-19 - Fast State-of-the-Art Tokenizers optimized for Research and Production
* [shimmy](https://github.com/Michael-A-Kuykendall/shimmy) ⭐ 3,683 | 🐛 28 | 🌐 Rust | 📅 2026-01-16 - Python-free Rust inference server for NLP models with OpenAI API compatibility and hot model swapping.
* [rust-bert](https://github.com/guillaume-be/rust-bert) ⭐ 3,038 | 🐛 73 | 🌐 Rust | 📅 2026-01-13 - Rust native ready-to-use NLP pipelines and transformer-based models (BERT, DistilBERT, GPT2,...)
...
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [CatBoost](https://github.com/catboost/catboost) ⭐ 8,808 | 🐛 678 | 🌐 C++ | 📅 2026-02-19 - General purpose gradient boosting on decision trees library with categorical features support out of the box for R.
...
* [Spark NLP](https://github.com/JohnSnowLabs/spark-nlp) ⭐ 4,107 | 🐛 19 | 🌐 Scala | 📅 2026-02-17 - Natural language processing library built on top of Apache Spark ML to provide simple, performant, and accurate NLP annotations for machine learning pipelines, that scale easily in a distributed environment.
...
* [H2O Sparkling Water](https://github.com/h2oai/sparkling-water) ⭐ 976 | 🐛 40 | 🌐 Scala | 📅 2025-11-05 - H2O and Spark interoperability.
...
* [isolation-forest](https://github.com/linkedin/isolation-forest) ⭐ 252 | 🐛 4 | 🌐 Scala | 📅 2026-02-11 - A distributed Spark/Scala implementation of the isolation forest algorithm for unsupervised outlier detection, featuring support for scalable training and ONNX export for easy cross-platform inference.
...
* [ONNX-Scala](https://github.com/EmergentOrder/onnx-scala) ⭐ 143 | 🐛 4 | 🌐 Scala | 📅 2026-02-17 - An ONNX (Open Neural Network eXchange) API and backend for typeful, functional deep learning in Scala (3).
...
* [Awesome Core ML Models](https://github.com/likedan/Awesome-CoreML-Models) ⭐ 6,947 | 🐛 11 | 🌐 Python | 📅 2025-06-17 - A curated list of machine learning models in CoreML format.
...
* [Swift AI](https://github.com/Swift-AI/Swift-AI) ⭐ 6,064 | 🐛 13 | 🌐 Swift | 📅 2017-05-03 - Highly optimized artificial intelligence and machine learning library written in Swift.
...
* [milvus](https://milvus.io) – Milvus is [open source](https://github.com/milvus-io/milvus) ⭐ 42,891 | 🐛 1,018 | 🌐 Go | 📅 2026-02-13 vector database for production AI, written in Go and C++, scalable and blazing fast for billions of embedding vectors.
* [Qdrant](https://qdrant.tech) – Qdrant is [open source](https://github.com/qdrant/qdrant) ⭐ 28,954 | 🐛 466 | 🌐 Rust | 📅 2026-02-19 vector similarity search engine with extended filtering support, written in Rust.
* [Weaviate](https://www.semi.technology/developers/weaviate/current/) – Weaviate is an [open source](https://github.com/semi-technologies/weaviate) ⭐ 15,618 | 🐛 610 | 🌐 Go | 📅 2026-02-19 vector search engine and vector database. Weaviate uses machine learning to vectorize and store data, and to find answers to natural language queries. With Weaviate you can also bring your custom ML models to production scale.
* [DVC](https://github.com/iterative/dvc) ⭐ 15,376 | 🐛 161 | 🌐 Python | 📅 2026-02-16 - Data Science Version Control is an open-source version control system for machine learning projects with pipelines support. It makes ML projects reproducible and shareable.
* [txtai](https://github.com/neuml/txtai) ⭐ 12,172 | 🐛 9 | 🌐 Python | 📅 2026-02-18 - Build semantic search applications and workflows.
* [Kedro](https://github.com/quantumblacklabs/kedro/) ⭐ 10,763 | 🐛 183 | 🌐 Python | 📅 2026-02-19 - Kedro is a data and development workflow framework that implements best practices for data pipelines with an eye towards productionizing machine learning models.
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 10,529 | 🐛 238 | 🌐 TypeScript | 📅 2026-02-20 - Open-source LLM evaluation and red teaming framework. Test prompts, models, agents, and RAG pipelines. Run adversarial attacks (jailbreaks, prompt injection) and integrate security testing into CI/CD.
* [PraisonAI](https://github.com/MervinPraison/PraisonAI) ⭐ 5,593 | 🐛 59 | 🌐 Python | 📅 2026-02-19 - Production-ready Multi-AI Agents framework with self-reflection. Fastest agent instantiation (3.77μs), 100+ LLM support via LiteLLM, MCP integration, agentic workflows (route/parallel/loop/repeat), built-in memory, Python & JS SDKs.
* [Infinity](https://github.com/infiniflow/infinity) ⭐ 4,393 | 🐛 141 | 🌐 C++ | 📅 2026-02-16 - The AI-native database built for LLM applications, providing incredibly fast vector and full-text search. Developed using C++20
...
* [m2cgen](https://github.com/BayesWitnesses/m2cgen) ⭐ 2,959 | 🐛 60 | 🌐 Python | 📅 2024-08-03 - A tool that allows the conversion of ML models into native code (Java, C, Python, Go, JavaScript, Visual Basic, C#, R, PowerShell, PHP, Dart) with zero dependencies.
* [Deepnote](https://github.com/deepnote/deepnote) ⭐ 2,667 | 🐛 14 | 🌐 TypeScript | 📅 2026-02-19 - Deepnote is a drop-in replacement for Jupyter with an AI-first design, sleek UI, new blocks, and native data integrations. Use Python, R, and SQL locally in your favorite IDE, then scale to Deepnote cloud for real-time collaboration, Deepnote agent, and deployable data apps.
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,406 | 🐛 171 | 🌐 Jupyter Notebook | 📅 2026-02-17 - a lightweight library to define data transformations as a directed-acyclic graph (DAG). It helps author reliable feature engineering and machine learning pipelines, and more.
* [VDP](https://github.com/instill-ai/vdp) ⭐ 2,309 | 🐛 39 | 🌐 Python | 📅 2026-02-16 - open source visual data ETL to streamline the end-to-end visual data processing pipeline: extract unstructured visual data from pre-built data sources, transform it into analysable structured insights by Vision AI models imported from various ML platforms, and load the insights into warehouses or applications.
* [Agentic Radar](https://github.com/splx-ai/agentic-radar) ⭐ 913 | 🐛 13 | 🌐 Python | 📅 2025-11-27 -  Open-source CLI security scanner for agentic workflows. Scans your workflow’s source code, detects vulnerabilities, and generates an interactive visualization along with a detailed security report. Supports LangGraph, CrewAI, n8n, OpenAI Agents, and more.
...
* [Agentfield](https://github.com/Agent-Field/agentfield) ⭐ 702 | 🐛 29 | 🌐 Go | 📅 2026-02-18 - Open source Kubernetes-style control plane for deploying AI agents as distributed microservices, with built-in service discovery, durable workflows, and observability.
...
* [DVClive](https://github.com/iterative/dvclive) ⭐ 186 | 🐛 33 | 🌐 Python | 📅 2026-02-16 - Python library for experiment metrics logging into simply formatted local files.
...
* [Distributed Machine Learning Patterns](https://github.com/terrytangyuan/distributed-ml-patterns) ⭐ 492 | 🐛 0 | 🌐 Python | 📅 2026-01-06  - This book teaches you how to take machine learning models from your personal laptop to large distributed clusters. You’ll explore key concepts and patterns behind successful distributed machine learning systems, and learn technologies like TensorFlow, Kubernetes, Kubeflow, and Argo Workflows directly from a key maintainer and contributor, with real-world scenarios and hands-on projects.
...
* Some of the python libraries were cut-and-pasted from [vinta](https://github.com/vinta/awesome-python) ⭐ 283,700 | 🐛 17 | 🌐 Python | 📅 2026-02-19
