# Awesome Machine Learning [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 443,494 | 🐛 73 | 📅 2026-03-04 [![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/josephmisiti/awesome-machine-learning/) with stars
...
* For a list of free machine learning books available for download, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/books.md) ⭐ 71,892 | 🐛 21 | 🌐 Python | 📅 2026-01-29.

* For a list of professional machine learning events, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/events.md) ⭐ 71,892 | 🐛 21 | 🌐 Python | 📅 2026-01-29.

* For a list of (mostly) free machine learning courses available online, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/courses.md) ⭐ 71,892 | 🐛 21 | 🌐 Python | 📅 2026-01-29.

* For a list of blogs and newsletters on data science and machine learning, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/blogs.md) ⭐ 71,892 | 🐛 21 | 🌐 Python | 📅 2026-01-29.

* For a list of free-to-attend meetups and local events, go [here](https://github.com/josephmisiti/awesome-machine-learning/blob/master/meetups.md) ⭐ 71,892 | 🐛 21 | 🌐 Python | 📅 2026-01-29.
...
* [Darknet](https://github.com/pjreddie/darknet) ⭐ 26,440 | 🐛 1,977 | 🌐 C | 📅 2024-05-03 - Darknet is an open source neural network framework written in C and CUDA. It is fast, easy to install, and supports CPU and GPU computation.
...
* [YOLOv8](https://github.com/ultralytics/ultralytics) ⭐ 54,047 | 🐛 316 | 🌐 Python | 📅 2026-03-08 - Ultralytics' YOLOv8 implementation with C++ support for real-time object detection and tracking, optimized for edge devices.
* [CCV](https://github.com/liuliu/ccv) ⭐ 7,198 | 🐛 78 | 🌐 C++ | 📅 2026-03-06 - C-based/Cached/Core Computer Vision Library, A Modern Computer Vision Library.
...
* [Openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 33,834 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - A real-time multi-person keypoint detection library for body, face, hands, and foot estimation
* [VIGRA](https://github.com/ukoethe/vigra) ⭐ 436 | 🐛 101 | 🌐 C++ | 📅 2025-12-23 - VIGRA is a genertic cross-platform C++ computer vision and machine learning library for volumes of arbitrary dimensionality with Python bindings.
...
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,772 | 🐛 1,175 | 🌐 C++ | 📅 2024-07-31 - A deep learning framework developed with cleanliness, readability, and speed in mind. \[DEEP LEARNING]
* [XGBoost](https://github.com/dmlc/xgboost) ⭐ 28,094 | 🐛 470 | 🌐 C++ | 📅 2026-03-04 - A parallelized optimized general purpose gradient boosting library.
...
* [LightGBM](https://github.com/Microsoft/LightGBM) ⭐ 18,138 | 🐛 484 | 🌐 C++ | 📅 2026-03-08 - Microsoft's fast, distributed, high performance gradient boosting (GBDT, GBRT, GBM or MART) framework based on decision tree algorithms, used for ranking, classification and many other machine learning tasks.
* [Opik](https://www.comet.com/site/products/opik/) - Open source engineering platform to debug, evaluate, and monitor your LLM applications, RAG systems, and agentic workflows with comprehensive tracing, automated evaluations, and production-ready dashboards. ([Source Code](https://github.com/comet-ml/opik/) ⭐ 18,093 | 🐛 160 | 🌐 Python | 📅 2026-03-07)
...
* [PyCaret](https://github.com/pycaret/pycaret) ⭐ 9,708 | 🐛 423 | 🌐 Jupyter Notebook | 📅 2025-04-21 - An open-source, low-code machine learning library in Python that automates machine learning workflows.
* [CatBoost](https://github.com/catboost/catboost) ⭐ 8,829 | 🐛 686 | 🌐 C++ | 📅 2026-03-07 - General purpose gradient boosting on decision trees library with categorical features support out of the box. It is easy to install, contains fast inference implementation and supports CPU and GPU (even multi-GPU) computation.
* [Vowpal Wabbit (VW)](https://github.com/VowpalWabbit/vowpal_wabbit) ⭐ 8,662 | 🐛 0 | 🌐 C++ | 📅 2026-03-04 - A fast out-of-core learning system.
* [Speedster](https://github.com/nebuly-ai/nebullvm/tree/main/apps/accelerate/speedster) ⭐ 8,352 | 🐛 111 | 🌐 Python | 📅 2024-07-22 -Automatically apply SOTA optimization techniques to achieve the maximum inference speed-up on your hardware. \[DEEP LEARNING]
* [Featuretools](https://github.com/featuretools/featuretools) ⭐ 7,618 | 🐛 163 | 🌐 Python | 📅 2026-02-03 - A library for automated feature engineering. It excels at transforming transactional and relational datasets into feature matrices for machine learning using reusable feature engineering "primitives".
* [Feast](https://github.com/gojek/feast) ⭐ 6,771 | 🐛 298 | 🌐 Python | 📅 2026-03-07 - A feature store for the management, discovery, and access of machine learning features. Feast provides a consistent view of feature data for both model training and model serving.
...
* [oneDNN](https://github.com/oneapi-src/oneDNN) ⭐ 3,958 | 🐛 151 | 🌐 C++ | 📅 2026-03-08 - An open-source cross-platform performance library for deep learning applications.
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,698 | 🐛 123 | 📅 2026-02-25 - A platform for reproducible and scalable machine learning and deep learning.
...
* [xLearn](https://github.com/aksnzhy/xlearn) ⭐ 3,096 | 🐛 194 | 🌐 C++ | 📅 2023-08-28 - A high performance, easy-to-use, and scalable machine learning package, which can be used to solve large-scale machine learning problems. xLearn is especially useful for solving machine learning problems on large-scale sparse data, which is very common in Internet services such as online advertising and recommender systems.
* [Shogun](https://github.com/shogun-toolbox/shogun) ⭐ 3,071 | 🐛 423 | 🌐 C++ | 📅 2023-12-19 - The Shogun Machine Learning Toolbox.
* [DeepDetect](https://github.com/jolibrain/deepdetect) ⭐ 2,549 | 🐛 96 | 🌐 C++ | 📅 2026-01-13 - A machine learning API and server written in C++11. It makes state of the art machine learning easy to work with and integrate into existing applications.
* * [Agentic Context Engine](https://github.com/kayba-ai/agentic-context-engine) ⭐ 1,957 | 🐛 7 | 🌐 Python | 📅 2026-03-07 -In-context learning framework that allows agents to learn from execution feedback.
* [nndeploy](https://github.com/nndeploy/nndeploy) ⭐ 1,754 | 🐛 21 | 🌐 C++ | 📅 2026-02-23 - An Easy-to-Use and High-Performance AI deployment framework.
* [ThunderSVM](https://github.com/Xtra-Computing/thundersvm) ⭐ 1,620 | 🐛 87 | 🌐 C++ | 📅 2024-04-01 - A fast SVM library on GPUs and CPUs.
...
* [Hopsworks](https://github.com/logicalclocks/hopsworks) ⭐ 1,287 | 🐛 16 | 🌐 Java | 📅 2025-02-10 - A data-intensive platform for AI with the industry's first open-source feature store. The Hopsworks Feature Store provides both a feature warehouse for training and batch based on Apache Hive and a feature serving database, based on MySQL Cluster, for online applications.
...
* [Intel® oneAPI Data Analytics Library](https://github.com/oneapi-src/oneDAL) ⭐ 646 | 🐛 68 | 🌐 C++ | 📅 2026-03-06 - A high performance software library developed by Intel and optimized for Intel's architectures. Library provides algorithmic building blocks for all stages of data analytics and allows to process data in batch, online and distributed modes.
* [Fido](https://github.com/FidoProject/Fido) ⭐ 461 | 🐛 15 | 🌐 C++ | 📅 2020-01-05 - A highly-modular C++ machine learning library for embedded electronics and robotics.
* [XAD](https://github.com/auto-differentiation/XAD) ⭐ 411 | 🐛 4 | 🌐 C++ | 📅 2026-03-02 - Comprehensive backpropagation tool for C++.
* [ParaMonte](https://github.com/cdslaborg/paramonte) ⭐ 301 | 🐛 20 | 🌐 Fortran | 📅 2025-12-18 - A general-purpose library with C/C++ interface for Bayesian data analysis and visualization via serial/parallel Monte Carlo and MCMC simulations. Documentation can be found [here](https://www.cdslab.org/paramonte/).
...
* [SentencePiece](https://github.com/google/sentencepiece) ⭐ 11,677 | 🐛 27 | 🌐 C++ | 📅 2026-03-01 - A C++ library for unsupervised text tokenization and detokenization, widely used in modern NLP models.
...
* [ucto](https://github.com/LanguageMachines/ucto) ⭐ 70 | 🐛 12 | 🌐 C++ | 📅 2026-03-01 - Unicode-aware regular-expression based tokenizer for various languages. Tool and C++ library. Supports FoLiA format.
...
* [Kaldi](https://github.com/kaldi-asr/kaldi) ⭐ 15,339 | 🐛 254 | 🌐 Shell | 📅 2025-09-22 - Kaldi is a toolkit for speech recognition written in C++ and licensed under the Apache License v2.0. Kaldi is intended for use by speech recognition researchers.
* [Vosk](https://github.com/alphacep/vosk-api) ⭐ 14,346 | 🐛 587 | 🌐 Jupyter Notebook | 📅 2026-02-22 - An offline speech recognition toolkit with C++ support, designed for low-resource devices and multiple languages.
...
* [grt](https://github.com/nickgillian/grt) ⭐ 885 | 🐛 88 | 🌐 C++ | 📅 2019-11-01 - The Gesture Recognition Toolkit (GRT) is a cross-platform, open-source, C++ machine learning library designed for real-time gesture recognition.

<a name="cpp-reinforcement-learning"></a>

#### Reinforcement Learning

* [RLtools](https://github.com/rl-tools/rl-tools) ⭐ 931 | 🐛 19 | 🌐 C++ | 📅 2026-03-01 - The fastest deep reinforcement learning library for continuous control, implemented header-only in pure, dependency-free C++ (Python bindings available as well).
...
* [mgl](https://github.com/melisgl/mgl/) ⭐ 642 | 🐛 6 | 🌐 Common Lisp | 📅 2025-06-07 - Neural networks (boltzmann machines, feed-forward and recurrent nets), Gaussian Processes.
...
* [Infer](https://github.com/aria42/infer) ⭐ 176 | 🐛 2 | 🌐 Clojure | 📅 2015-12-29 - Inference and machine learning in Clojure. **\[Deprecated]**
...
* [Deep Diamond](https://github.com/uncomplicate/deep-diamond) ⭐ 458 | 🐛 1 | 🌐 Clojure | 📅 2026-02-22 - A fast Clojure Tensor & Deep Learning library
...
* [tech.ml.dataset](https://github.com/techascent/tech.ml.dataset) ⭐ 738 | 🐛 30 | 🌐 Clojure | 📅 2026-03-04 - Clojure dataframe library and pipeline for data processing and machine learning
* [PigPen](https://github.com/Netflix/PigPen) ⭐ 566 | 🐛 19 | 🌐 Clojure | 📅 2023-04-10 - Map-Reduce for Clojure.
* [Tablecloth](https://github.com/scicloj/tablecloth) ⭐ 355 | 🐛 46 | 🌐 Clojure | 📅 2026-02-10 - A dataframe grammar wrapping tech.ml.dataset, inspired by several R libraries
...
* [Hanami](https://github.com/jsa-aerial/hanami) ⭐ 408 | 🐛 8 | 🌐 Clojure | 📅 2025-07-02 - Clojure(Script) library and framework for creating interactive visualization applications based in Vega-Lite (VGL) and/or Vega (VG) specifications. Automatic framing and layouts along with a powerful templating system for abstracting visualization specs
...
* [Libpython-clj](https://github.com/clj-python/libpython-clj) ⭐ 1,194 | 🐛 33 | 🌐 Clojure | 📅 2026-01-19 - Interop with Python
...
* [kixistats](https://github.com/MastodonC/kixi.stats) ⭐ 370 | 🐛 1 | 🌐 Clojure | 📅 2025-11-10 - A library of statistical distribution sampling and transducing functions
...
* [Knowledge3D (K3D)](https://github.com/danielcamposramos/Knowledge3D) ⭐ 32 | 🐛 2 | 🌐 Python | 📅 2026-03-07 - Sovereign GPU-native spatial AI architecture with PTX-first cognitive engine (RPN/TRM reasoning), tri-modal fusion (text/visual/audio), and 3D persistent memory ("Houses"). Features sub-100µs inference, procedural knowledge compression (69:1 ratio), and multi-agent swarm architecture. Zero external dependencies for core inference paths.
...
* [neural-fortran](https://github.com/modern-fortran/neural-fortran) ⭐ 461 | 🐛 42 | 🌐 Fortran | 📅 2026-03-04 - A parallel neural net microframework.
...
* [ParaMonte](https://github.com/cdslaborg/paramonte) ⭐ 301 | 🐛 20 | 🌐 Fortran | 📅 2025-12-18 - A general-purpose Fortran library for Bayesian data analysis and visualization via serial/parallel Monte Carlo and MCMC simulations. Documentation can be found [here](https://www.cdslab.org/paramonte/).
...
* [sentences](https://github.com/neurosnap/sentences) ⭐ 465 | 🐛 5 | 🌐 Go | 📅 2024-02-28 - Golang implementation of Punkt sentence tokenizer.
...
* [golearn](https://github.com/sjwhitworth/golearn) ⭐ 9,449 | 🐛 89 | 🌐 Go | 📅 2024-01-15 - Machine learning for Go.
* [gorgonia](https://github.com/gorgonia/gorgonia) ⭐ 5,913 | 🐛 119 | 🌐 Go | 📅 2024-08-12 - Deep learning in Go.
...
* [Cloudforest](https://github.com/ryanbressler/CloudForest) ⭐ 750 | 🐛 34 | 🌐 Go | 📅 2022-02-05 - Ensembles of decision trees in Go/Golang. **\[Deprecated]**
* [gobrain](https://github.com/goml/gobrain) ⭐ 567 | 🐛 2 | 🌐 Go | 📅 2020-12-12 - Neural Networks written in Go.
* [leaves](https://github.com/dmitryikh/leaves) ⭐ 470 | 🐛 37 | 🌐 Go | 📅 2024-07-03 - A pure Go implementation of the prediction part of GBRTs, including XGBoost and LightGBM.
...
* [gogeo](https://github.com/golang/geo) ⭐ 1,823 | 🐛 33 | 🌐 Go | 📅 2026-03-02 - Spherical geometry in Go.
* [go-geom](https://github.com/twpayne/go-geom) ⭐ 958 | 🐛 9 | 🌐 Go | 📅 2026-03-06 - Go library to handle geometries.
...
* [GoCV](https://github.com/hybridgroup/gocv) ⭐ 7,399 | 🐛 348 | 🌐 Go | 📅 2026-02-18 - Package for computer vision using OpenCV 4 and beyond.

<a name="go-reinforcement-learning"></a>

#### Reinforcement learning

* [stable-baselines3](https://github.com/DLR-RM/stable-baselines3) ⭐ 12,837 | 🐛 79 | 🌐 Python | 📅 2026-02-21 - PyTorch implementations of Stable Baselines (deep) reinforcement learning algorithms.
...
* [HLearn](https://github.com/mikeizbicki/HLearn) ⭐ 1,720 | 🐛 23 | 🌐 Haskell | 📅 2016-05-29 - a suite of libraries for interpreting machine learning models according to their algebraic structure. **\[Deprecated]**
...
* [Twitter Text Java](https://github.com/twitter/twitter-text/tree/master/java) ⭐ 3,129 | 🐛 93 | 🌐 HTML | 📅 2024-04-26 - A Java implementation of Twitter's text processing library.
...
* [H2O](https://github.com/h2oai/h2o-3) ⭐ 7,505 | 🐛 2,882 | 🌐 Jupyter Notebook | 📅 2026-03-08 - ML engine that supports distributed learning on Hadoop, Spark or your laptop via APIs in R, Python, Scala, REST/JSON.
* [aerosolve](https://github.com/airbnb/aerosolve) ⭐ 4,800 | 🐛 10 | 🌐 Scala | 📅 2025-11-06 - A machine learning library by Airbnb designed from the ground up to be human friendly.
* [Mahout](https://github.com/apache/mahout) ⭐ 2,219 | 🐛 68 | 🌐 Rust | 📅 2026-03-07 - Distributed machine learning.
...
* [SystemML](https://github.com/apache/systemml) ⭐ 1,079 | 🐛 80 | 🌐 Java | 📅 2026-03-06 - flexible, scalable machine learning (ML) language.
...
* [htm.java](https://github.com/numenta/htm.java) ⭐ 317 | 🐛 49 | 🌐 Java | 📅 2021-10-23 - General Machine Learning library using Numenta’s Cortical Learning Algorithm.
* [liblinear-java](https://github.com/bwaldvogel/liblinear-java) ⭐ 310 | 🐛 7 | 🌐 Java | 📅 2024-12-31 - Java version of liblinear.
* [rapaio](https://github.com/padreati/rapaio) ⭐ 76 | 🐛 7 | 🌐 Java | 📅 2026-03-07 - statistics, data mining and machine learning toolbox in Java.
* [Chips-n-Salsa](https://github.com/cicirello/Chips-n-Salsa) ⭐ 73 | 🐛 3 | 🌐 Java | 📅 2026-02-27 - A Java library for genetic algorithms, evolutionary computation, and stochastic local search, with a focus on self-adaptation / self-tuning, as well as parallel execution.
...
* [Spark](https://github.com/apache/spark) ⭐ 42,942 | 🐛 260 | 🌐 Scala | 📅 2026-03-07 - Spark is a fast and general engine for large-scale data processing.
* [Hadoop](https://github.com/apache/hadoop) ⭐ 15,497 | 🐛 105 | 🌐 Java | 📅 2026-03-07 - Hadoop/HDFS.
...
* [Deeplearning4j](https://github.com/deeplearning4j/deeplearning4j) ⭐ 14,207 | 🐛 615 | 🌐 Java | 📅 2026-03-05 - Scalable deep learning for industry with parallel GPUs.
* [deepjavalibrary/djl](https://github.com/deepjavalibrary/djl) ⭐ 4,782 | 🐛 222 | 🌐 Java | 📅 2026-03-05 - Deep Java Library (DJL) is an open-source, high-level, engine-agnostic Java framework for deep learning, designed to be easy to get started with and simple to use for Java developers.
...
* [NLP Compromise](https://github.com/spencermountain/compromise) ⭐ 12,045 | 🐛 118 | 🌐 JavaScript | 📅 2026-02-25 - Natural Language processing in the browser.
* [natural](https://github.com/NaturalNode/natural) ⭐ 10,871 | 🐛 80 | 🌐 JavaScript | 📅 2026-02-22 - General natural language facilities for node.
* [nlp.js](https://github.com/axa-group/nlp.js) ⭐ 6,559 | 🐛 116 | 🌐 JavaScript | 📅 2025-01-09 - An NLP library built in node over Natural, with entity extraction, sentiment analysis, automatic language identify, and so more.
* [Knwl.js](https://github.com/loadfive/Knwl.js) ⭐ 5,283 | 🐛 13 | 🌐 JavaScript | 📅 2023-09-28 - A Natural Language Processor in JS.
* [Twitter-text](https://github.com/twitter/twitter-text) ⭐ 3,129 | 🐛 93 | 🌐 HTML | 📅 2024-04-26 - A JavaScript implementation of Twitter's text processing library.
* [Retext](https://github.com/retextjs/retext) ⭐ 2,432 | 🐛 0 | 🌐 JavaScript | 📅 2025-02-04 - Extensible system for analyzing and manipulating natural language.

<a name="javascript-data-analysis--data-visualization"></a>

#### Data Analysis / Data Visualization

* [science.js](https://github.com/jasondavies/science.js/) ⭐ 892 | 🐛 14 | 🌐 JavaScript | 📅 2026-03-06 - Scientific and statistical computing in JavaScript. **\[Deprecated]**
...
* [cheminfo](https://www.cheminfo.org/) - Platform for data visualization and analysis, using the [visualizer](https://github.com/npellet/visualizer) ⭐ 51 | 🐛 185 | 🌐 JavaScript | 📅 2026-03-06 project.
...
* [Netron](https://github.com/lutzroeder/netron) ⭐ 32,538 | 🐛 20 | 🌐 JavaScript | 📅 2026-03-07 - Visualizer for machine learning models.
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [Brain.js](https://github.com/BrainJS/brain.js) ⭐ 14,869 | 🐛 91 | 🌐 TypeScript | 📅 2024-09-26 - Neural networks in JavaScript - continued community fork of [Brain](https://github.com/harthur/brain) ⚠️ Archived.
...
* [ml5](https://github.com/ml5js/ml5-library) ⭐ 6,585 | 🐛 288 | 🌐 JavaScript | 📅 2024-10-11 - Friendly machine learning for the web!
...
* [ml.js](https://github.com/mljs/ml) ⭐ 2,711 | 🐛 27 | 🌐 JavaScript | 📅 2024-10-21 - Machine learning and numerical analysis tools for Node.js and the Browser!
...
* [Auto ML](https://github.com/ClimbsRocks/auto_ml) ⭐ 1,655 | 🐛 187 | 🌐 Python | 📅 2021-02-10 - Automated machine learning, data formatting, ensembling, and hyperparameter optimization for competitions and exploration- just give it a .csv file! **\[Deprecated]**
...
* [Decision Trees](https://github.com/serendipious/nodejs-decision-tree-id3) ⭐ 218 | 🐛 6 | 🌐 TypeScript | 📅 2026-03-01 - NodeJS Implementation of Decision Tree using ID3 Algorithm. **\[Deprecated]**
...
* [Creatify MCP](https://github.com/TSavo/creatify-mcp) ⭐ 17 | 🐛 2 | 🌐 TypeScript | 📅 2025-05-26 - Model Context Protocol server that exposes Creatify AI's video generation capabilities to AI assistants, enabling natural language video creation workflows.
...
* [stdlib](https://github.com/stdlib-js/stdlib) ⭐ 5,764 | 🐛 1,188 | 🌐 JavaScript | 📅 2026-03-08 - A standard library for JavaScript and Node.js, with an emphasis on numeric computing. The library provides a collection of robust, high performance libraries for mathematics, statistics, streams, utilities, and more.
* [simple-statistics](https://github.com/simple-statistics/simple-statistics) ⭐ 3,497 | 🐛 26 | 🌐 JavaScript | 📅 2026-03-01 - A JavaScript implementation of descriptive, regression, and inference statistics. Implemented in literate JavaScript with no dependencies, designed to work in all modern browsers (including IE) as well as in Node.js.
* [Pipcook](https://github.com/alibaba/pipcook) ⭐ 2,591 | 🐛 110 | 🌐 TypeScript | 📅 2026-03-08 - A JavaScript application framework for machine learning and its engineering.
...
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [MLJ](https://github.com/alan-turing-institute/MLJ.jl) ⭐ 1,902 | 🐛 84 | 🌐 Julia | 📅 2026-02-08 - A Julia machine learning framework.
...
* [GLM](https://github.com/JuliaStats/GLM.jl) ⭐ 632 | 🐛 81 | 🌐 Julia | 📅 2026-02-28 - Generalized linear models in Julia.
...
* [Mixed Models](https://github.com/dmbates/MixedModels.jl) ⭐ 438 | 🐛 58 | 🌐 Julia | 📅 2026-03-04 - A Julia package for fitting (statistical) mixed-effects models.
* [MultivariateStats](https://github.com/JuliaStats/MultivariateStats.jl) ⭐ 385 | 🐛 52 | 🌐 Julia | 📅 2026-02-20 - Methods for dimensionality reduction.
...
* [GaussianMixtures](https://github.com/davidavdav/GaussianMixtures.jl) ⭐ 106 | 🐛 23 | 🌐 Julia | 📅 2026-01-08 - Large scale Gaussian Mixture Models.
* [GLMNet](https://github.com/simonster/GLMNet.jl) ⭐ 104 | 🐛 13 | 🌐 Julia | 📅 2026-01-13 - Julia wrapper for fitting Lasso/ElasticNet GLM models using glmnet.
...
* [Text Analysis](https://github.com/JuliaText/TextAnalysis.jl) ⭐ 379 | 🐛 39 | 🌐 Julia | 📅 2025-11-17 - Julia package for text analysis.
...
* [Embeddings](https://github.com/JuliaText/Embeddings.jl) ⭐ 83 | 🐛 11 | 🌐 Julia | 📅 2024-03-08 - Functions and data dependencies for loading various word embeddings
...
* [Gadfly](https://github.com/GiovineItalia/Gadfly.jl) ⭐ 1,920 | 🐛 276 | 🌐 Julia | 📅 2025-10-04 - Crafty statistical graphics for Julia.
* [DataFrames](https://github.com/JuliaData/DataFrames.jl) ⭐ 1,814 | 🐛 160 | 🌐 Julia | 📅 2026-02-22 - library for working with tabular data in Julia.
* [Distributions](https://github.com/JuliaStats/Distributions.jl) ⭐ 1,186 | 🐛 470 | 🌐 Julia | 📅 2026-03-05 - A Julia package for probability distributions and associated functions.
* [LightGraphs](https://github.com/JuliaGraphs/LightGraphs.jl) ⚠️ Archived - Graph modelling and analysis.
* [Data Frames Meta](https://github.com/JuliaData/DataFramesMeta.jl) ⭐ 498 | 🐛 38 | 🌐 Julia | 📅 2025-11-24 - Metaprogramming tools for DataFrames.
...
* [RDataSets](https://github.com/johnmyleswhite/RDatasets.jl) ⭐ 165 | 🐛 19 | 🌐 R | 📅 2026-01-03 - Julia package for loading many of the data sets available in R.
...
* [KotlinDL](https://github.com/JetBrains/KotlinDL) ⭐ 1,571 | 🐛 81 | 🌐 Kotlin | 📅 2024-05-31 - Deep learning framework written in Kotlin.
...
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,772 | 🐛 1,175 | 🌐 C++ | 📅 2024-07-31 - A deep learning framework developed with cleanliness, readability, and speed in mind.
* [MXNet](https://github.com/apache/incubator-mxnet/) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [Pattern Recognition and Machine Learning](https://github.com/PRML/PRMLT) ⭐ 6,204 | 🐛 0 | 🌐 MATLAB | 📅 2020-03-04 - This package contains the matlab implementation of the algorithms described in the book Pattern Recognition and Machine Learning by C. Bishop.
* [ThunderSVM](https://github.com/Xtra-Computing/thundersvm) ⭐ 1,620 | 🐛 87 | 🌐 C++ | 📅 2024-04-01 - An Open-Source SVM Library on GPUs and CPUs
...
* [ParaMonte](https://github.com/cdslaborg/paramonte) ⭐ 301 | 🐛 20 | 🌐 Fortran | 📅 2025-12-18 - A general-purpose MATLAB library for Bayesian data analysis and visualization via serial/parallel Monte Carlo and MCMC simulations. Documentation can be found [here](https://www.cdslab.org/paramonte/).
...
* [ML.NET](https://github.com/dotnet/machinelearning) ⭐ 9,331 | 🐛 997 | 🌐 C# | 📅 2026-03-06 - ML.NET is a cross-platform open-source machine learning framework which makes machine learning accessible to .NET developers. ML.NET was originally developed in Microsoft Research and evolved into a significant framework over the last decade and is used across many product groups in Microsoft like Windows, Bing, PowerPoint, Excel and more.
* [GeneticSharp](https://github.com/giacomelli/GeneticSharp) ⭐ 1,358 | 🐛 12 | 🌐 C# | 📅 2025-11-13 - Multi-platform genetic algorithm library for .NET Core and .NET Framework. The library has several implementations of GA operators, like: selection, crossover, mutation, reinsertion and termination.
...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 86,487 | 🐛 2,723 | 🌐 C++ | 📅 2026-03-06 - A OpenSource Computer Vision Library
...
* [jieba-php](https://github.com/fukuball/jieba-php) ⭐ 1,373 | 🐛 4 | 🌐 PHP | 📅 2025-12-16 - Chinese Words Segmentation Utilities.
...
* [face\_recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,183 | 🐛 833 | 🌐 Python | 📅 2024-08-21 - Face recognition library that recognizes and manipulates faces from Python or from the command line.
* [timm](https://github.com/rwightman/pytorch-image-models) ⭐ 36,458 | 🐛 66 | 🌐 Python | 📅 2026-03-08 - PyTorch image models, scripts, pretrained weights -- ResNet, ResNeXT, EfficientNet, EfficientNetV2, NFNet, Vision Transformer, MixNet, MobileNet-V3/V2, RegNet, DPN, CSPNet, and more.
* [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,181 | 🐛 585 | 🌐 Python | 📅 2025-11-17 - FAIR's next-generation research platform for object detection and segmentation. It is a ground-up rewrite of the previous version, Detectron, and is powered by the PyTorch deep learning framework.
* [Openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 33,834 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - A real-time multi-person keypoint detection library for body, face, hands, and foot estimation
...
* [MLX](https://github.com/ml-explore/mlx) ⭐ 24,276 | 🐛 185 | 🌐 C++ | 📅 2026-03-07- MLX is an array framework for machine learning on Apple silicon, developed by Apple machine learning research.
* [deepface](https://github.com/serengil/deepface) ⭐ 22,332 | 🐛 6 | 🌐 Python | 📅 2026-03-01 - A lightweight face recognition and facial attribute analysis (age, gender, emotion and race) framework for Python covering cutting-edge models such as VGG-Face, FaceNet, OpenFace, DeepFace, DeepID, Dlib and ArcFace.
...
* [segmentation\_models.pytorch](https://github.com/qubvel/segmentation_models.pytorch) ⭐ 11,379 | 🐛 90 | 🌐 Python | 📅 2025-12-23 - A PyTorch-based toolkit that offers pre-trained segmentation models for computer vision tasks. It simplifies the development of image segmentation applications by providing a collection of popular architecture implementations, such as UNet and PSPNet, along with pre-trained weights, making it easier for researchers and developers to achieve high-quality pixel-level object segmentation in images.
* [Exadel CompreFace](https://github.com/exadel-inc/CompreFace) ⭐ 7,817 | 🐛 233 | 🌐 Java | 📅 2024-10-05 - face recognition system that can be easily integrated into any system without prior machine learning skills. CompreFace provides REST API for face recognition, face verification, face detection, face mask detection, landmark detection, age, and gender recognition and is easily deployed with docker.
* [Scikit-Image](https://github.com/scikit-image/scikit-image) ⭐ 6,468 | 🐛 875 | 🌐 Python | 📅 2026-03-06 - A collection of algorithms for image processing in Python.
* [Scikit-Opt](https://github.com/guofei9987/scikit-opt) ⭐ 6,382 | 🐛 70 | 🌐 Python | 📅 2025-08-31 - Swarm Intelligence in Python (Genetic Algorithm, Particle Swarm Optimization, Simulated Annealing, Ant Colony Algorithm, Immune Algorithm, Artificial Fish Swarm Algorithm in Python)
* [pytessarct](https://github.com/madmaze/pytesseract) ⭐ 6,323 | 🐛 19 | 🌐 Python | 📅 2026-01-19 - Python-tesseract is an optical character recognition (OCR) tool for python. That is, it will recognize and "read" the text embedded in images. Python-tesseract is a wrapper for [Google's Tesseract-OCR Engine](https://github.com/tesseract-ocr/tesseract) ⭐ 72,751 | 🐛 464 | 🌐 C++ | 📅 2026-02-28.
...
* [imutils](https://github.com/jrosebr1/imutils) ⭐ 4,592 | 🐛 164 | 🌐 Python | 📅 2024-06-24 - A library containing Convenience functions to make basic image processing operations such as translation, rotation, resizing, skeletonization, and displaying Matplotlib images easier with OpenCV and Python.
...
* [lightly](https://github.com/lightly-ai/lightly) ⭐ 3,691 | 🐛 83 | 🌐 Python | 📅 2026-03-04 - Lightly is a computer vision framework for self-supervised learning.
...
* [retinaface](https://github.com/serengil/retinaface) ⭐ 1,924 | 🐛 1 | 🌐 Python | 📅 2025-08-11 - deep learning based cutting-edge facial detector for Python coming with facial landmarks
* [LightlyTrain](https://github.com/lightly-ai/lightly-train) ⭐ 1,344 | 🐛 57 | 🌐 Python | 📅 2026-03-06 - Pretrain computer vision models on unlabeled data for industrial applications
...
* [Vigranumpy](https://github.com/ukoethe/vigra) ⭐ 436 | 🐛 101 | 🌐 C++ | 📅 2025-12-23 - Python bindings for the VIGRA C++ computer vision library.
* [joliGEN](https://github.com/jolibrain/joliGEN) ⭐ 280 | 🐛 32 | 🌐 Python | 📅 2026-03-03 - Generative AI Image Toolset with GANs and Diffusion for Real-World Applications.
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 157,539 | 🐛 2,289 | 🌐 Python | 📅 2026-03-07 - A deep learning library containing thousands of pre-trained models on different tasks. The goto place for anything related to Large Language Models.
* [jieba](https://github.com/fxsjy/jieba#jieba-1) ⭐ 34,782 | 🐛 699 | 🌐 Python | 📅 2024-08-21 - Chinese Words Segmentation Utilities.
* [spaCy](https://github.com/explosion/spaCy) ⭐ 33,282 | 🐛 193 | 🌐 Python | 📅 2026-03-03 - Industrial strength NLP with Python and Cython.
* [Haystack](https://github.com/deepset-ai/haystack) ⭐ 24,426 | 🐛 115 | 🌐 MDX | 📅 2026-03-07 - A framework for building industrial-strength applications with Transformer models and LLMs.
* [Rasa](https://github.com/RasaHQ/rasa) ⭐ 21,084 | 🐛 145 | 🌐 Python | 📅 2026-01-29 - A "machine learning framework to automate text-and voice-based conversations."
* [CometLLM](https://github.com/comet-ml/comet-llm) ⭐ 18,093 | 🐛 160 | 🌐 Python | 📅 2026-03-07 - Track, log, visualize and evaluate your LLM prompts and prompt chains.
* [Fuzzy Wuzzy](https://github.com/seatgeek/fuzzywuzzy) ⚠️ Archived - Fuzzy String Matching in Python.
* [Pattern](https://github.com/clips/pattern) ⭐ 8,858 | 🐛 178 | 🌐 Python | 📅 2024-06-10 - A web mining module for the Python programming language. It has tools for natural language processing, machine learning, among others.
* [DeepPavlov](https://github.com/deepmipt/DeepPavlov/) ⭐ 6,970 | 🐛 50 | 🌐 Python | 📅 2025-08-06 - conversational AI library with many pre-trained Russian NLP models.
...
* [SnowNLP](https://github.com/isnowfy/snownlp) ⭐ 6,610 | 🐛 44 | 🌐 Python | 📅 2020-01-19 - A library for processing Chinese text.
...
* [Snips NLU](https://github.com/snipsco/snips-nlu) ⭐ 3,961 | 🐛 67 | 🌐 Python | 📅 2023-05-22 - Natural Language Understanding library for intent classification and entity extraction
* [Polyglot](https://github.com/aboSamoor/polyglot) ⭐ 2,366 | 🐛 170 | 🌐 Python | 📅 2023-11-10 - Multilingual text (NLP) processing toolkit.
* [textacy](https://github.com/chartbeat-labs/textacy) ⭐ 2,235 | 🐛 35 | 🌐 Python | 📅 2023-09-22 - higher-level NLP built on Spacy.
* [jellyfish](https://github.com/jamesturk/jellyfish) ⭐ 2,194 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-03-03 - a python library for doing approximate and phonetic matching of strings.
* [NeuroNER](https://github.com/Franck-Dernoncourt/NeuroNER) ⭐ 1,720 | 🐛 91 | 🌐 Python | 📅 2023-03-24 - Named-entity recognition using neural networks providing state-of-the-art-results
...
* [CLTK](https://github.com/cltk/cltk) ⭐ 898 | 🐛 5 | 🌐 Python | 📅 2026-02-12 - The Classical Language Toolkit.
* [NobodyWho](https://github.com/nobodywho-ooo/nobodywho) ⭐ 718 | 🐛 39 | 🌐 Rust | 📅 2026-03-06 - The simplest way to run an LLM locally. Supports tool calling and grammar constrained sampling.
* [BigARTM](https://github.com/bigartm/bigartm) ⭐ 672 | 🐛 138 | 🌐 C++ | 📅 2026-02-05 - topic modelling platform.
* [stanford-corenlp-python](https://github.com/dasmith/stanford-corenlp-python) ⭐ 610 | 🐛 47 | 🌐 Python | 📅 2018-03-14 - Python wrapper for [Stanford CoreNLP](https://github.com/stanfordnlp/CoreNLP) ⭐ 10,060 | 🐛 182 | 🌐 Java | 📅 2026-02-10 **\[Deprecated]**
* [DL Translate](https://github.com/xhlulu/dl-translate) ⭐ 497 | 🐛 5 | 🌐 Python | 📅 2024-09-02 - A deep learning-based translation library between 50 languages, built with `transformers`.
...
* [VeritasGraph](https://github.com/bibinprathap/VeritasGraph) ⭐ 249 | 🐛 0 | 🌐 Python | 📅 2026-03-07 - Enterprise-Grade Graph RAG for Secure, On-Premise AI with Verifiable Attribution.
...
* [TensorFlow](https://github.com/tensorflow/tensorflow/) ⭐ 194,035 | 🐛 3,686 | 🌐 C++ | 📅 2026-03-08 - Open source software library for numerical computation using data flow graphs.
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 98,026 | 🐛 18,089 | 🌐 Python | 📅 2026-03-08 - Tensors and Dynamic neural networks in Python with strong GPU acceleration
* [keras](https://github.com/keras-team/keras) ⭐ 63,911 | 🐛 287 | 🌐 Python | 📅 2026-03-07 - High-level neural networks frontend for [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 194,035 | 🐛 3,686 | 🌐 C++ | 📅 2026-03-08, [CNTK](https://github.com/Microsoft/CNTK) ⚠️ Archived and [Theano](https://github.com/Theano/Theano) ⭐ 9,984 | 🐛 698 | 🌐 Python | 📅 2024-01-15.
* [Streamlit](https://github.com/streamlit/streamlit) ⭐ 43,788 | 🐛 1,299 | 🌐 Python | 📅 2026-03-07: Streamlit is an framework to create beautiful data apps in hours, not weeks.
* [Gradio](https://github.com/gradio-app/gradio) ⭐ 41,954 | 🐛 451 | 🌐 Python | 📅 2026-03-07 - A Python library for quickly creating and sharing demos of models. Debug models interactively in your browser, get feedback from collaborators, and generate public links without deploying anything.
* [Colossal-AI](https://github.com/hpcaitech/ColossalAI) ⭐ 41,360 | 🐛 492 | 🌐 Python | 📅 2026-03-02: An open-source deep learning system for large-scale model training and inference with high efficiency and low cost.
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 38,651 | 🐛 192 | 🌐 Python | 📅 2026-03-06 - Open Source framework to streamline use of neural networks.
* [JAX](https://github.com/google/jax) ⭐ 35,018 | 🐛 2,225 | 🌐 Python | 📅 2026-03-07 - JAX is Autograd and XLA, brought together for high-performance machine learning research.
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,772 | 🐛 1,175 | 🌐 C++ | 📅 2024-07-31 - A deep learning framework developed with cleanliness, readability, and speed in mind.
* [ML-From-Scratch](https://github.com/eriklindernoren/ML-From-Scratch) ⭐ 30,962 | 🐛 71 | 🌐 Python | 📅 2023-10-15 - Implementations of Machine Learning models from scratch in Python with a focus on transparency. Aims to showcase the nuts and bolts of ML in an accessible way.
* [PyTorch Lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 30,906 | 🐛 965 | 🌐 Python | 📅 2026-03-06 - The lightweight PyTorch wrapper for high-performance AI research.
* [Bayesian Methods for Hackers](https://github.com/CamDavidsonPilon/Probabilistic-Programming-and-Bayesian-Methods-for-Hackers) ⭐ 28,425 | 🐛 204 | 🌐 Jupyter Notebook | 📅 2024-06-25 - Book/iPython notebooks on Probabilistic Programming in Python.
* [XGBoost](https://github.com/dmlc/xgboost) ⭐ 28,094 | 🐛 470 | 🌐 C++ | 📅 2026-03-04 - Python bindings for eXtreme Gradient Boosting (Tree) Library.
* [Fastai](https://github.com/fastai/fastai) ⭐ 27,888 | 🐛 265 | 🌐 Jupyter Notebook | 📅 2026-02-26 - High-level wrapper built on the top of Pytorch which supports vision, text, tabular data and collaborative filtering.
* [PyTorch Geometric](https://github.com/pyg-team/pytorch_geometric) ⭐ 23,543 | 🐛 1,255 | 🌐 Python | 📅 2026-03-02 -> Graph Neural Network Library for PyTorch.
* [Microsoft Recommenders](https://github.com/Microsoft/Recommenders) ⭐ 21,496 | 🐛 171 | 🌐 Python | 📅 2026-03-01: Examples and best practices for building recommendation systems, provided as Jupyter notebooks. The repo contains some of the latest state of the art algorithms from Microsoft Research as well as from other companies and institutions.
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [Opik](https://github.com/comet-ml/opik) ⭐ 18,093 | 🐛 160 | 🌐 Python | 📅 2026-03-07: Evaluate, trace, test, and ship LLM applications across your dev and production lifecycles.
...
* [Neural Networks and Deep Learning](https://github.com/mnielsen/neural-networks-and-deep-learning) ⭐ 17,478 | 🐛 7 | 🌐 Python | 📅 2024-06-02 - Code samples for my book "Neural Networks and Deep Learning" \[DEEP LEARNING].
* [gensim](https://github.com/RaRe-Technologies/gensim) ⭐ 16,373 | 🐛 434 | 🌐 Python | 📅 2025-11-01 - Topic Modelling for Humans.
* [numpy-ML](https://github.com/ddbourgin/numpy-ml) ⭐ 16,295 | 🐛 40 | 🌐 Python | 📅 2023-10-29: Reference implementations of ML models written in numpy
* [Annoy](https://github.com/spotify/annoy) ⭐ 14,175 | 🐛 75 | 🌐 C++ | 📅 2025-10-29 - Approximate nearest neighbours implementation.
* [Optuna](https://github.com/optuna/optuna) ⭐ 13,625 | 🐛 34 | 🌐 Python | 📅 2026-03-06: Optuna is an automatic hyperparameter optimization software framework, particularly designed for machine learning.
* [cleanlab](https://github.com/cleanlab/cleanlab) ⭐ 11,358 | 🐛 100 | 🌐 Python | 📅 2026-01-13: The standard data-centric AI package for data quality and machine learning with messy, real-world data and labels.
...
* [AutoGluon](https://github.com/awslabs/autogluon) ⭐ 10,062 | 🐛 388 | 🌐 Python | 📅 2026-03-06: AutoML for Image, Text, Tabular, Time-Series, and MultiModal Data.
* [TPOT](https://github.com/EpistasisLab/tpot) ⭐ 10,048 | 🐛 308 | 🌐 Jupyter Notebook | 📅 2025-09-11 - Tool that automatically creates and optimizes machine learning pipelines using genetic programming. Consider it your personal data science assistant, automating a tedious part of machine learning.
* [Theano](https://github.com/Theano/Theano/) ⭐ 9,984 | 🐛 698 | 🌐 Python | 📅 2024-01-15 - Optimizing GPU-meta-programming code generating array oriented optimizing math compiler in Python.
* [PySyft](https://github.com/OpenMined/PySyft) ⭐ 9,858 | 🐛 65 | 🌐 Python | 📅 2025-07-15 - A Python library for secure and private Deep Learning built on PyTorch and TensorFlow.
* [PyOD](https://github.com/yzhao062/pyod) ⭐ 9,741 | 🐛 239 | 🌐 Python | 📅 2026-03-01 -> Python Outlier Detection, comprehensive and scalable Python toolkit for detecting outlying objects in multivariate data. Featured for Advanced models, including Neural Networks/Deep Learning and Outlier Ensembles.
* [sktime](https://github.com/alan-turing-institute/sktime) ⭐ 9,604 | 🐛 1,907 | 🌐 Python | 📅 2026-03-07 - A unified framework for machine learning with time series
* [TFLearn](https://github.com/tflearn/tflearn) ⭐ 9,601 | 🐛 579 | 🌐 Python | 📅 2024-05-06 - Deep learning library featuring a higher-level API for TensorFlow.
* [einops](https://github.com/arogozhnikov/einops) ⭐ 9,420 | 🐛 33 | 🌐 Python | 📅 2026-02-20 - Deep learning operations reinvented (for pytorch, tensorflow, jax and others).
* [Hub](https://github.com/activeloopai/Hub) ⭐ 9,023 | 🐛 64 | 🌐 C++ | 📅 2026-02-16 - Fastest unstructured dataset management for TensorFlow/PyTorch. Stream & version-control data. Store even petabyte-scale data in a single numpy-like array on the cloud accessible on any machine. Visit [activeloop.ai](https://activeloop.ai) for more info.
* [pattern](https://github.com/clips/pattern) ⭐ 8,858 | 🐛 178 | 🌐 Python | 📅 2024-06-10 - Web mining module for Python.
* [CatBoost](https://github.com/catboost/catboost) ⭐ 8,829 | 🐛 686 | 🌐 C++ | 📅 2026-03-07 - General purpose gradient boosting on decision trees library with categorical features support out of the box. It is easy to install, well documented and supports CPU and GPU (even multi-GPU) computation.
* [BentoML](https://github.com/bentoml/bentoml) ⭐ 8,492 | 🐛 139 | 🌐 Python | 📅 2026-03-06: Toolkit for package and deploy machine learning models for serving in production
* [Cortex](https://github.com/cortexlabs/cortex) ⭐ 8,029 | 🐛 131 | 🌐 Go | 📅 2024-06-12 - Open source platform for deploying machine learning models in production.
* [Evidently](https://github.com/evidentlyai/evidently) ⭐ 7,280 | 🐛 253 | 🌐 Jupyter Notebook | 📅 2026-02-27: Interactive reports to analyze machine learning models during validation or production monitoring.
* [InterpretML](https://github.com/interpretml/interpret) ⭐ 6,805 | 🐛 111 | 🌐 C++ | 📅 2026-03-08 - InterpretML implements the Explainable Boosting Machine (EBM), a modern, fully interpretable machine learning model based on Generalized Additive Models (GAMs). This open-source package also provides visualization tools for EBMs, other glass-box models, and black-box explanations.
* [NuPIC](https://github.com/numenta/nupic) ⭐ 6,357 | 🐛 464 | 🌐 Python | 📅 2024-12-03 - Numenta Platform for Intelligent Computing.
* [deap](https://github.com/deap/deap) ⭐ 6,348 | 🐛 284 | 🌐 Python | 📅 2025-11-16 - Evolutionary algorithm framework.
* [skorch](https://github.com/skorch-dev/skorch) ⭐ 6,151 | 🐛 66 | 🌐 Jupyter Notebook | 📅 2026-02-25 - A scikit-learn compatible neural network library that wraps PyTorch.
* [Aim](https://github.com/aimhubio/aim) ⭐ 6,020 | 🐛 451 | 🌐 Python | 📅 2026-03-07 -> An easy-to-use & supercharged open-source AI metadata tracker.
* [Chainer](https://github.com/chainer/chainer) ⭐ 5,922 | 🐛 12 | 🌐 Python | 📅 2023-08-28 - Flexible neural network framework.
* [River](https://github.com/online-ml/river) ⭐ 5,741 | 🐛 114 | 🌐 Python | 📅 2026-03-01: A framework for general purpose online machine learning.
* [Microsoft ML for Apache Spark](https://github.com/Azure/mmlspark) ⭐ 5,204 | 🐛 381 | 🌐 Scala | 📅 2026-03-04 -> A distributed machine learning framework Apache Spark
* [mlxtend](https://github.com/rasbt/mlxtend) ⭐ 5,119 | 🐛 157 | 🌐 Python | 📅 2026-01-24 - A library consisting of useful tools for data science and machine learning tasks.
...
* [Deepchecks](https://github.com/deepchecks/deepchecks) ⭐ 3,986 | 🐛 259 | 🌐 Python | 📅 2025-12-28: Validation & testing of machine learning models and data during model development, deployment, and production. This includes checks and suites related to various types of issues, such as model performance, data integrity, distribution mismatches, and more.
...
* [pomegranate](https://github.com/jmschrei/pomegranate) ⭐ 3,509 | 🐛 41 | 🌐 Python | 📅 2025-03-06 - Hidden Markov Models for Python, implemented in Cython for speed and efficiency.
...
* [PyBroker](https://github.com/edtechre/pybroker) ⭐ 3,220 | 🐛 4 | 🌐 Python | 📅 2026-03-05 - Algorithmic Trading with Machine Learning.
* [Determined](https://github.com/determined-ai/determined) ⭐ 3,213 | 🐛 106 | 🌐 Go | 📅 2025-03-20 - Scalable deep learning training platform, including integrated support for distributed training, hyperparameter tuning, experiment tracking, and model management.
* [pgmpy](https://github.com/pgmpy/pgmpy) ⭐ 3,197 | 🐛 563 | 🌐 Python | 📅 2026-03-07 A python library for working with Probabilistic Graphical Models.
* [Shapash](https://github.com/MAIF/shapash) ⭐ 3,150 | 🐛 48 | 🌐 Jupyter Notebook | 📅 2026-02-06 : Shapash is a Python library that provides several types of visualization that display explicit labels that everyone can understand.
...
* [PyTorch Geometric Temporal](https://github.com/benedekrozemberczki/pytorch_geometric_temporal) ⭐ 2,955 | 🐛 29 | 🌐 Python | 📅 2025-09-18 -> A temporal extension of PyTorch Geometric for dynamic graph representation learning.
* [PyBrain](https://github.com/pybrain/pybrain) ⭐ 2,865 | 🐛 156 | 🌐 Python | 📅 2024-06-27 - Another Python Machine Learning Library.
* [Pylearn2](https://github.com/lisa-lab/pylearn2) ⭐ 2,773 | 🐛 201 | 🌐 Python | 📅 2021-08-20 - A Machine Learning library based on [Theano](https://github.com/Theano/Theano) ⭐ 9,984 | 🐛 698 | 🌐 Python | 📅 2024-01-15. **\[Deprecated]**
* [modAL](https://github.com/modAL-python/modAL) ⭐ 2,341 | 🐛 108 | 🌐 Python | 📅 2024-02-26 - A modular active learning framework for Python, built on top of scikit-learn.
...
* [Feature-engine](https://github.com/feature-engine/feature_engine) ⭐ 2,209 | 🐛 72 | 🌐 Python | 📅 2026-03-05 - Open source library with an exhaustive battery of feature engineering and selection methods based on pandas and scikit-learn.
...
* [thinking bayes](https://github.com/AllenDowney/ThinkBayes) ⭐ 1,687 | 🐛 12 | 🌐 TeX | 📅 2021-03-12 - Book on Bayesian Analysis.
* [auto\_ml](https://github.com/ClimbsRocks/auto_ml) ⭐ 1,655 | 🐛 187 | 🌐 Python | 📅 2021-02-10 - Automated machine learning for production and analytics. Lets you focus on the fun parts of ML, while outputting production-ready code, and detailed analytics of your dataset and results. Includes support for NLP, XGBoost, CatBoost, LightGBM, and soon, deep learning.
* [skrub](https://github.com/skrub-data/skrub) ⭐ 1,576 | 🐛 146 | 🌐 Python | 📅 2026-03-06 - Skrub is a Python library that eases preprocessing and feature engineering for machine learning on dataframes.
...
* [MCP Memory Service](https://github.com/doobidoo/mcp-memory-service) ⭐ 1,467 | 🐛 5 | 🌐 Python | 📅 2026-03-07 - Universal memory service with semantic search, autonomous consolidation, and multi-client support for AI applications.
* [skforecast](https://github.com/skforecast/skforecast) ⭐ 1,461 | 🐛 22 | 🌐 Python | 📅 2026-03-07 - Python library for time series forecasting using machine learning models. It works with any regressor compatible with the scikit-learn API, including popular options like LightGBM, XGBoost, CatBoost, Keras, and many others.
* [metric-learn](https://github.com/metric-learn/metric-learn) ⭐ 1,431 | 🐛 52 | 🌐 Python | 📅 2024-08-03 - A Python module for metric learning.
* [pydeep](https://github.com/andersbll/deeppy) ⭐ 1,378 | 🐛 22 | 🌐 Python | 📅 2020-12-28 - Deep Learning In Python. **\[Deprecated]**
* [nilearn](https://github.com/nilearn/nilearn) ⭐ 1,367 | 🐛 299 | 🌐 Python | 📅 2026-03-06 - Machine learning for NeuroImaging in Python.
* [Intel(R) Extension for Scikit-learn](https://github.com/intel/scikit-learn-intelex) ⭐ 1,332 | 🐛 85 | 🌐 Python | 📅 2026-03-07 - A seamless way to speed up your Scikit-learn applications with no accuracy loss and code changes.
* [Brainstorm](https://github.com/IDSIA/brainstorm) ⭐ 1,303 | 🐛 27 | 🌐 Python | 📅 2022-09-13 - Fast, flexible and fun neural networks. This is the successor of PyBrain.
...
* [dtaidistance](https://github.com/wannesm/dtaidistance) ⭐ 1,218 | 🐛 21 | 🌐 Python | 📅 2026-02-12 - High performance library for time series distances (DTW) and time series clustering.
...
* [Cornac](https://github.com/PreferredAI/cornac) ⭐ 1,019 | 🐛 33 | 🌐 Python | 📅 2025-12-18 - A comparative framework for multimodal recommender systems with a focus on models leveraging auxiliary data.
...
* [scikit-multiflow](https://github.com/scikit-multiflow/scikit-multiflow) ⭐ 794 | 🐛 73 | 🌐 Python | 📅 2023-11-02 - A machine learning framework for multi-output/multi-label and stream data.
* [PyTorch Frame](https://github.com/pyg-team/pytorch-frame) ⭐ 772 | 🐛 25 | 🌐 Python | 📅 2026-03-04 -> A Modular Framework for Multi-Modal Tabular Learning.
* [ChemicalX](https://github.com/AstraZeneca/chemicalx) ⭐ 771 | 🐛 10 | 🌐 Python | 📅 2023-09-11 -> A PyTorch based deep learning library for drug pair scoring
...
* [FEDOT](https://github.com/nccr-itmo/FEDOT) ⭐ 703 | 🐛 81 | 🌐 Python | 📅 2026-03-06: An AutoML framework for the automated design of composite modelling pipelines. It can handle classification, regression, and time series forecasting tasks on different types of data (including multi-modal datasets).
...
* [Opytimizer](https://github.com/gugarosa/opytimizer) ⭐ 632 | 🐛 0 | 🌐 Python | 📅 2026-02-16 - Python-based meta-heuristic optimization techniques.
...
* [pyhsmm](https://github.com/mattjj/pyhsmm) ⭐ 574 | 🐛 46 | 🌐 Python | 📅 2025-01-25 - library for approximate unsupervised inference in Bayesian Hidden Markov Models (HMMs) and explicit-duration Hidden semi-Markov Models (HSMMs), focusing on the Bayesian Nonparametric extensions, the HDP-HMM and HDP-HSMM, mostly with weak-limit approximations.
...
* [ChefBoost](https://github.com/serengil/chefboost) ⭐ 487 | 🐛 0 | 🌐 Python | 📅 2025-07-09 - a lightweight decision tree framework for Python with categorical feature support covering regular decision tree algorithms such as ID3, C4.5, CART, CHAID and regression tree; also some advanced bagging and boosting techniques such as gradient boosting, random forest and adaboost.
* [imbalanced-ensemble](https://github.com/ZhiningLiu1998/imbalanced-ensemble) ⭐ 418 | 🐛 1 | 🌐 Python | 📅 2026-03-05 - Python toolbox for quick implementation, modification, evaluation, and visualization of ensemble learning algorithms for class-imbalanced data. Supports out-of-the-box multi-class imbalanced (long-tailed) classification.
...
* [Sklearn-genetic-opt](https://github.com/rodrigo-arenas/Sklearn-genetic-opt) ⭐ 356 | 🐛 4 | 🌐 Python | 📅 2025-09-13: An AutoML package for hyperparameters tuning using evolutionary algorithms, with built-in callbacks, plotting, remote logging and more.
...
* [Frouros](https://github.com/IFCA/frouros) ⭐ 252 | 🐛 13 | 🌐 Python | 📅 2026-03-01: Frouros is an open source Python library for drift detection in machine learning systems.
...
* [topicwizard](https://github.com/x-tabdeveloping/topic-wizard) ⭐ 144 | 🐛 3 | 🌐 Python | 📅 2025-03-19 - Interactive topic model visualization/interpretation framework.
...
* [Neurolink](https://github.com/juspay/neurolink) ⭐ 112 | 🐛 430 | 🌐 TypeScript | 📅 2026-03-07 - Enterprise-grade LLM integration framework for building production-ready AI applications with built-in hallucination prevention, RAG, and MCP support.
...
* [Superset](https://github.com/apache/incubator-superset) ⭐ 70,843 | 🐛 1,153 | 🌐 TypeScript | 📅 2026-03-07 - A data exploration platform designed to be visual, intuitive, and interactive.
* [Dash](https://github.com/plotly/dash) ⭐ 24,440 | 🐛 572 | 🌐 Python | 📅 2026-03-06 - A framework for creating analytical web applications built on top of Plotly.js, React, and Flask
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,362 | 🐛 861 | 🌐 TypeScript | 📅 2026-03-07 - Interactive Web Plotting for Python.
* [zipline](https://github.com/quantopian/zipline) ⭐ 19,474 | 🐛 367 | 🌐 Python | 📅 2024-02-13 - A Pythonic algorithmic trading library.
* [SymPy](https://github.com/sympy/sympy) ⭐ 14,447 | 🐛 5,575 | 🌐 Python | 📅 2026-03-07 - A Python library for symbolic mathematics.
...
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,284 | 🐛 2,968 | 🌐 Python | 📅 2026-03-03 - Statistical modelling and econometrics in Python.
* [altair](https://github.com/altair-viz/altair) ⭐ 10,287 | 🐛 153 | 🌐 Python | 📅 2026-03-05 - A Python to Vega translator.
* [PyMC](https://github.com/pymc-devs/pymc) ⭐ 9,515 | 🐛 487 | 🌐 Python | 📅 2026-03-08 - Markov Chain Monte Carlo sampling toolkit.
* [Vaex](https://github.com/vaexio/vaex) ⭐ 8,492 | 🐛 550 | 🌐 Python | 📅 2026-03-01 - A high performance Python library for lazy Out-of-Core DataFrames (similar to Pandas), to visualize and explore big tabular datasets. Documentation can be found [here](https://vaex.io/docs/index.html).
* [PyQtGraph](https://github.com/pyqtgraph/pyqtgraph) ⭐ 4,301 | 🐛 505 | 🌐 Python | 📅 2026-02-27 - A pure-python graphics and GUI library built on PyQt4 / PySide and NumPy.
* [ggplot](https://github.com/yhat/ggpy) ⭐ 3,696 | 🐛 178 | 🌐 Python | 📅 2023-01-21 - Same API as ggplot2 for R. **\[Deprecated]**
* [bqplot](https://github.com/bloomberg/bqplot) ⭐ 3,684 | 🐛 277 | 🌐 TypeScript | 📅 2026-01-23 - An API for plotting in Jupyter (IPython).
* [vispy](https://github.com/vispy/vispy) ⭐ 3,553 | 🐛 379 | 🌐 Python | 📅 2026-03-02 - GPU-based high-performance interactive OpenGL 2D/3D data visualization library.
* [TensorWatch](https://github.com/microsoft/tensorwatch) ⭐ 3,463 | 🐛 53 | 🌐 Jupyter Notebook | 📅 2026-03-06 - Debugging and visualization tool for machine learning and data science. It extensively leverages Jupyter Notebook to show real-time visualizations of data in running processes such as machine learning training.
* [Blaze](https://github.com/blaze/blaze) ⭐ 3,195 | 🐛 268 | 🌐 Python | 📅 2023-09-29 - NumPy and Pandas interface to Big Data.
* [Mars](https://github.com/mars-project/mars) ⭐ 2,748 | 🐛 215 | 🌐 Python | 📅 2024-01-02 - A tensor-based framework for large-scale data computation which is often regarded as a parallel and distributed version of NumPy.
...
* [Dora](https://github.com/nathanepstein/dora) ⭐ 649 | 🐛 0 | 🌐 Python | 📅 2025-08-05 - Tools for exploratory data analysis in Python.
* [DataComPy](https://github.com/capitalone/datacompy) ⭐ 639 | 🐛 9 | 🌐 Python | 📅 2026-02-20 - A library to compare Pandas, Polars, and Spark data frames. It provides stats and lets users adjust for match accuracy.
...
* [ParaMonte](https://github.com/cdslaborg/paramonte) ⭐ 301 | 🐛 20 | 🌐 Fortran | 📅 2025-12-18 - A general-purpose Python library for Bayesian data analysis and visualization via serial/parallel Monte Carlo and MCMC simulations. Documentation can be found [here](https://www.cdslab.org/paramonte/).
...
* [data-science-ipython-notebooks](https://github.com/donnemartin/data-science-ipython-notebooks) ⭐ 28,904 | 🐛 42 | 🌐 Python | 📅 2024-03-20 - Continually updated Data Science Python Notebooks: Spark, Hadoop MapReduce, HDFS, AWS, Kaggle, scikit-learn, matplotlib, pandas, NumPy, SciPy, and various command lines.
* [handsonml](https://github.com/ageron/handson-ml) ⭐ 25,834 | 🐛 145 | 🌐 Jupyter Notebook | 📅 2023-10-03 - Fundamentals of machine learning in python.
* [Pydata book](https://github.com/wesm/pydata-book) ⭐ 24,364 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2025-10-17 - Materials and IPython notebooks for "Python for Data Analysis" by Wes McKinney, published by O'Reilly Media
* [Homemade Machine Learning](https://github.com/trekhleb/homemade-machine-learning) ⭐ 24,292 | 🐛 28 | 🌐 Jupyter Notebook | 📅 2025-11-23 - Python examples of popular machine learning algorithms with interactive Jupyter demos and math being explained
* [A gallery of interesting IPython notebooks](https://github.com/jupyter/jupyter/wiki/A-gallery-of-interesting-Jupyter-Notebooks) ⭐ 15,288 | 🐛 44 | 🌐 Python | 📅 2025-12-17
...
* [Introduction to Machine Learning with Python](https://github.com/amueller/introduction_to_ml_with_python) ⭐ 8,053 | 🐛 28 | 🌐 Jupyter Notebook | 📅 2024-03-14 - Notebooks and code for the book "Introduction to Machine Learning with Python"
* [pandas cookbook](https://github.com/jvns/pandas-cookbook) ⭐ 7,038 | 🐛 33 | 🌐 Jupyter Notebook | 📅 2024-10-24 - Recipes for using Python's pandas library.
* [numpic](https://github.com/numenta/nupic) ⭐ 6,357 | 🐛 464 | 🌐 Python | 📅 2024-12-03
* [pattern\_classification](https://github.com/rasbt/pattern_classification) ⭐ 4,212 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2023-11-26
* [Introduction to machine learning with scikit-learn](https://github.com/justmarkham/scikit-learn-videos) ⭐ 3,781 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2024-03-05 - IPython notebooks from Data School's video tutorials on scikit-learn.
...
* [Allen Downey’s Think Bayes Code](https://github.com/AllenDowney/ThinkBayes) ⭐ 1,687 | 🐛 12 | 🌐 TeX | 📅 2021-03-12 - Code repository for Think Bayes.
...
* [Hyperparameter-Optimization-of-Machine-Learning-Algorithms](https://github.com/LiYangHart/Hyperparameter-Optimization-of-Machine-Learning-Algorithms) ⭐ 1,321 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2022-09-22 - Code for hyperparameter tuning/optimization of machine learning and deep learning algorithms.
* [Suiron](https://github.com/kendricktan/suiron/) ⭐ 708 | 🐛 3 | 🌐 Python | 📅 2016-10-08 - Machine Learning for RC Cars.
* [ipython-notebooks](https://github.com/ogrisel/notebooks) ⭐ 574 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-02-26
* [Allen Downey’s Think OS Code](https://github.com/AllenDowney/ThinkOS) ⭐ 569 | 🐛 7 | 🌐 TeX | 📅 2020-04-28 - Text and supporting code for Think OS: A Brief Introduction to Operating Systems.
* [the-elements-of-statistical-learning](https://github.com/maitbayev/the-elements-of-statistical-learning) ⭐ 426 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-02-10 - This repository contains Jupyter notebooks implementing the algorithms found in the book and summary of the textbook.
...
* [NeuralTalk](https://github.com/karpathy/neuraltalk2) ⭐ 5,576 | 🐛 142 | 🌐 Jupyter Notebook | 📅 2017-11-07 - NeuralTalk is a Python+numpy project for learning Multimodal Recurrent Neural Networks that describe images with sentences. **\[Deprecated]**
...
* [Tonic](https://github.com/neuromorphs/tonic) ⭐ 272 | 🐛 33 | 🌐 Python | 📅 2025-10-23 - A library that makes downloading publicly available neuromorphic datasets a breeze and provides event-based data transformation/augmentation pipelines.
* [Sinabs](https://github.com/synsense/sinabs) ⭐ 110 | 🐛 28 | 🌐 Python | 📅 2026-02-05 - A deep learning library for spiking neural networks which is based on PyTorch, focuses on fast training and supports inference on neuromorphic hardware.
...
* [lifelines](https://github.com/CamDavidsonPilon/lifelines) ⭐ 2,556 | 🐛 279 | 🌐 Python | 📅 2026-03-07 - lifelines is a complete survival analysis library, written in pure Python
* [Scikit-Survival](https://github.com/sebp/scikit-survival) ⭐ 1,277 | 🐛 30 | 🌐 Python | 📅 2026-03-08 - scikit-survival is a Python module for survival analysis built on top of scikit-learn. It allows doing survival analysis while utilizing the power of scikit-learn, e.g., for pre-processing or doing cross-validation.
...
* [PySyft](https://github.com/OpenMined/PySyft) ⭐ 9,858 | 🐛 65 | 🌐 Python | 📅 2025-07-15 - A Python library for secure and private Deep Learning.
...
* [RLlib](https://github.com/ray-project/ray) ⭐ 41,639 | 🐛 3,438 | 🌐 Python | 📅 2026-03-08 - RLlib is an industry level, highly scalable RL library for tf and torch, based on Ray. It's used by companies like Amazon and Microsoft to solve real-world decision making problems at scale.
* [Gymnasium](https://github.com/Farama-Foundation/Gymnasium) ⭐ 11,461 | 🐛 87 | 🌐 Python | 📅 2026-03-04 - A library for developing and comparing reinforcement learning algorithms (successor of \[gym])(<https://github.com/openai/gym> ⭐ 37,078 | 🐛 128 | 🌐 Python | 📅 2024-10-11).
* [DeepMind Lab](https://github.com/deepmind/lab) ⭐ 7,337 | 🐛 65 | 🌐 C | 📅 2023-01-04 - DeepMind Lab is a 3D learning environment based on id Software's Quake III Arena via ioquake3 and other open source software. Its primary purpose is to act as a testbed for research in artificial intelligence, especially deep reinforcement learning.
...
* [DI-engine](https://github.com/opendilab/DI-engine) ⭐ 3,598 | 🐛 26 | 🌐 Python | 📅 2025-12-07 - DI-engine is a generalized Decision Intelligence engine. It supports most basic deep reinforcement learning (DRL) algorithms, such as DQN, PPO, SAC, and domain-specific algorithms like QMIX in multi-agent RL, GAIL in inverse RL, and RND in exploration problems.
* [Retro](https://github.com/openai/retro) ⭐ 3,571 | 🐛 61 | 🌐 C | 📅 2024-02-22 - Retro Games in Gym
...
* [garage](https://github.com/rlworkgroup/garage) ⭐ 2,085 | 🐛 234 | 🌐 Python | 📅 2023-05-04 - A toolkit for reproducible reinforcement learning research
* [ViZDoom](https://github.com/mwydmuch/ViZDoom) ⭐ 1,982 | 🐛 28 | 🌐 C++ | 📅 2026-03-04 - ViZDoom allows developing AI bots that play Doom using only the visual information (the screen buffer). It is primarily intended for research in machine visual learning, and deep reinforcement learning, in particular.
* [metaworld](https://github.com/rlworkgroup/metaworld) ⭐ 1,753 | 🐛 8 | 🌐 Python | 📅 2026-01-20 - An open source robotics benchmark for meta- and multi-task reinforcement learning
* [SLM Lab](https://github.com/kengz/SLM-Lab) ⭐ 1,336 | 🐛 5 | 🌐 Python | 📅 2026-03-06 - Modular Deep Reinforcement Learning framework in PyTorch.
* [Maze](https://github.com/enlite-ai/maze) ⭐ 286 | 🐛 2 | 🌐 Python | 📅 2026-03-03 - Application-oriented deep reinforcement learning framework addressing real-world decision problems.
...
* [EspNet](https://github.com/espnet/espnet) ⭐ 9,755 | 🐛 52 | 🌐 Python | 📅 2026-03-05 - ESPnet is an end-to-end speech processing toolkit for tasks like speech recognition, translation, and enhancement, using PyTorch and Kaldi-style data processing.
...
* [Twitter-text-rb](https://github.com/twitter/twitter-text/tree/master/rb) ⭐ 3,129 | 🐛 93 | 🌐 HTML | 📅 2024-04-26 - A library that does auto linking and extraction of usernames, lists and hashtags in tweets.
...
* [rumale](https://github.com/yoshoku/rumale) ⭐ 903 | 🐛 0 | 🌐 Ruby | 📅 2026-02-19 - Rumale is a machine learning library in Ruby
* [CardMagic-Classifier](https://github.com/cardmagic/classifier) ⭐ 718 | 🐛 14 | 🌐 Ruby | 📅 2026-03-07 - A general classifier module to allow Bayesian and other types of classifications.
...
* [candle](https://github.com/huggingface/candle) ⭐ 19,599 | 🐛 620 | 🌐 Rust | 📅 2026-03-06 - Candle is a minimalist ML framework for Rust with a focus on performance (including GPU support) and ease of use.
* [leaf](https://github.com/autumnai/leaf) ⭐ 5,551 | 🐛 33 | 🌐 Rust | 📅 2024-03-20 - open source framework for machine intelligence, sharing concepts from TensorFlow and Caffe. Available under the MIT license. [**\[Deprecated\]**](https://medium.com/@mjhirn/tensorflow-wins-89b78b29aafb#.s0a3uy4cc)
* [linfa](https://github.com/rust-ml/linfa) ⭐ 4,573 | 🐛 68 | 🌐 Rust | 📅 2026-02-04 - a comprehensive toolkit to build Machine Learning applications with Rust
* [linfa](https://github.com/rust-ml/linfa) ⭐ 4,573 | 🐛 68 | 🌐 Rust | 📅 2026-02-04 - `linfa` aims to provide a comprehensive toolkit to build Machine Learning applications with Rust
* [rusty-machine](https://github.com/AtheMathmo/rusty-machine) ⚠️ Archived - a pure-rust machine learning library.
* [smartcore](https://github.com/smartcorelib/smartcore) ⭐ 894 | 🐛 59 | 🌐 Rust | 📅 2026-02-10 - "The Most Advanced Machine Learning Library In Rust."
* [rustlearn](https://github.com/maciejkula/rustlearn) ⭐ 640 | 🐛 13 | 🌐 Rust | 📅 2021-06-07 - a machine learning framework featuring logistic regression, support vector machines, decision trees and random forests.
...
* [burn](https://github.com/tracel-ai/burn) ⭐ 14,530 | 🐛 234 | 🌐 Rust | 📅 2026-03-07 - Burn is a new comprehensive dynamic Deep Learning Framework built using Rust with extreme flexibility, compute efficiency and portability as its primary goals
* [tch-rs](https://github.com/LaurentMazare/tch-rs) ⭐ 5,306 | 🐛 228 | 🌐 Rust | 📅 2026-01-22 - Rust bindings for the C++ API of PyTorch
...
* [huggingface/tokenizers](https://github.com/huggingface/tokenizers) ⭐ 10,507 | 🐛 147 | 🌐 Rust | 📅 2026-02-28 - Fast State-of-the-Art Tokenizers optimized for Research and Production
* [shimmy](https://github.com/Michael-A-Kuykendall/shimmy) ⭐ 3,744 | 🐛 28 | 🌐 Rust | 📅 2026-01-16 - Python-free Rust inference server for NLP models with OpenAI API compatibility and hot model swapping.
* [rust-bert](https://github.com/guillaume-be/rust-bert) ⭐ 3,050 | 🐛 73 | 🌐 Rust | 📅 2026-01-13 - Rust native ready-to-use NLP pipelines and transformer-based models (BERT, DistilBERT, GPT2,...)
...
* [MXNet](https://github.com/apache/incubator-mxnet) ⚠️ Archived - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Go, JavaScript and more.
* [CatBoost](https://github.com/catboost/catboost) ⭐ 8,829 | 🐛 686 | 🌐 C++ | 📅 2026-03-07 - General purpose gradient boosting on decision trees library with categorical features support out of the box for R.
* [Machine Learning For Hackers](https://github.com/johnmyleswhite/ML_for_Hackers) ⭐ 3,812 | 🐛 36 | 🌐 R | 📅 2019-05-26
...
* [SuperLearner](https://github.com/ecpolley/SuperLearner) ⭐ 286 | 🐛 21 | 🌐 R | 📅 2025-12-15 - Multi-algorithm ensemble learning packages.
...
* [Spark NLP](https://github.com/JohnSnowLabs/spark-nlp) ⭐ 4,114 | 🐛 20 | 🌐 Scala | 📅 2026-03-07 - Natural language processing library built on top of Apache Spark ML to provide simple, performant, and accurate NLP annotations for machine learning pipelines, that scale easily in a distributed environment.
...
* [Microsoft ML for Apache Spark](https://github.com/Azure/mmlspark) ⭐ 5,204 | 🐛 381 | 🌐 Scala | 📅 2026-03-04 -> A distributed machine learning framework Apache Spark
* [adam](https://github.com/bigdatagenomics/adam) ⭐ 1,047 | 🐛 42 | 🌐 Scala | 📅 2026-03-01 - A genomics processing engine and specialized file format built using Apache Avro, Apache Spark and Parquet. Apache 2 licensed.
...
* [DynaML](https://github.com/transcendent-ai-labs/DynaML) ⭐ 201 | 🐛 25 | 🌐 Scala | 📅 2023-04-21 - Scala Library/REPL for Machine Learning Research.
* [ONNX-Scala](https://github.com/EmergentOrder/onnx-scala) ⭐ 143 | 🐛 7 | 🌐 Scala | 📅 2026-02-17 - An ONNX (Open Neural Network eXchange) API and backend for typeful, functional deep learning in Scala (3).
...
* [Awesome Core ML Models](https://github.com/likedan/Awesome-CoreML-Models) ⭐ 6,966 | 🐛 12 | 🌐 Python | 📅 2025-06-17 - A curated list of machine learning models in CoreML format.
...
* [Swift AI](https://github.com/Swift-AI/Swift-AI) ⭐ 6,072 | 🐛 13 | 🌐 Swift | 📅 2017-05-03 - Highly optimized artificial intelligence and machine learning library written in Swift.
...
* [Awesome TensorFlow](https://github.com/jtoy/awesome-tensorflow) ⭐ 17,736 | 🐛 29 | 📅 2026-02-08 - A list of all things related to TensorFlow.
...
* [milvus](https://milvus.io) – Milvus is [open source](https://github.com/milvus-io/milvus) ⭐ 43,184 | 🐛 1,044 | 🌐 Go | 📅 2026-03-07 vector database for production AI, written in Go and C++, scalable and blazing fast for billions of embedding vectors.
* [Qdrant](https://qdrant.tech) – Qdrant is [open source](https://github.com/qdrant/qdrant) ⭐ 29,356 | 🐛 486 | 🌐 Rust | 📅 2026-03-08 vector similarity search engine with extended filtering support, written in Rust.
* [Weaviate](https://www.semi.technology/developers/weaviate/current/) – Weaviate is an [open source](https://github.com/semi-technologies/weaviate) ⭐ 15,757 | 🐛 591 | 🌐 Go | 📅 2026-03-07 vector search engine and vector database. Weaviate uses machine learning to vectorize and store data, and to find answers to natural language queries. With Weaviate you can also bring your custom ML models to production scale.
* [DVC](https://github.com/iterative/dvc) ⭐ 15,421 | 🐛 172 | 🌐 Python | 📅 2026-03-02 - Data Science Version Control is an open-source version control system for machine learning projects with pipelines support. It makes ML projects reproducible and shareable.
* [txtai](https://github.com/neuml/txtai) ⭐ 12,265 | 🐛 8 | 🌐 Python | 📅 2026-03-04 - Build semantic search applications and workflows.
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 10,846 | 🐛 244 | 🌐 TypeScript | 📅 2026-03-08 - Open-source LLM evaluation and red teaming framework. Test prompts, models, agents, and RAG pipelines. Run adversarial attacks (jailbreaks, prompt injection) and integrate security testing into CI/CD.
* [Kedro](https://github.com/quantumblacklabs/kedro/) ⭐ 10,781 | 🐛 201 | 🌐 Python | 📅 2026-03-06 - Kedro is a data and development workflow framework that implements best practices for data pipelines with an eye towards productionizing machine learning models.
* [PraisonAI](https://github.com/MervinPraison/PraisonAI) ⭐ 5,637 | 🐛 62 | 🌐 Python | 📅 2026-03-08 - Production-ready Multi-AI Agents framework with self-reflection. Fastest agent instantiation (3.77μs), 100+ LLM support via LiteLLM, MCP integration, agentic workflows (route/parallel/loop/repeat), built-in memory, Python & JS SDKs.
* [Infinity](https://github.com/infiniflow/infinity) ⭐ 4,424 | 🐛 67 | 🌐 C++ | 📅 2026-03-06 - The AI-native database built for LLM applications, providing incredibly fast vector and full-text search. Developed using C++20
...
* [m2cgen](https://github.com/BayesWitnesses/m2cgen) ⭐ 2,963 | 🐛 61 | 🌐 Python | 📅 2024-08-03 - A tool that allows the conversion of ML models into native code (Java, C, Python, Go, JavaScript, Visual Basic, C#, R, PowerShell, PHP, Dart) with zero dependencies.
* [Deepnote](https://github.com/deepnote/deepnote) ⭐ 2,710 | 🐛 20 | 🌐 TypeScript | 📅 2026-03-07 - Deepnote is a drop-in replacement for Jupyter with an AI-first design, sleek UI, new blocks, and native data integrations. Use Python, R, and SQL locally in your favorite IDE, then scale to Deepnote cloud for real-time collaboration, Deepnote agent, and deployable data apps.
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,421 | 🐛 160 | 🌐 Jupyter Notebook | 📅 2026-03-07 - a lightweight library to define data transformations as a directed-acyclic graph (DAG). It helps author reliable feature engineering and machine learning pipelines, and more.
* [VDP](https://github.com/instill-ai/vdp) ⭐ 2,307 | 🐛 40 | 🌐 Python | 📅 2026-03-08 - open source visual data ETL to streamline the end-to-end visual data processing pipeline: extract unstructured visual data from pre-built data sources, transform it into analysable structured insights by Vision AI models imported from various ML platforms, and load the insights into warehouses or applications.
* [Agentic Radar](https://github.com/splx-ai/agentic-radar) ⭐ 923 | 🐛 13 | 🌐 Python | 📅 2025-11-27 -  Open-source CLI security scanner for agentic workflows. Scans your workflow’s source code, detects vulnerabilities, and generates an interactive visualization along with a detailed security report. Supports LangGraph, CrewAI, n8n, OpenAI Agents, and more.
* [Agentfield](https://github.com/Agent-Field/agentfield) ⭐ 857 | 🐛 36 | 🌐 Go | 📅 2026-03-08 - Open source Kubernetes-style control plane for deploying AI agents as distributed microservices, with built-in service discovery, durable workflows, and observability.
...
* [Localforge](https://localforge.dev/) – Is an [open source](https://github.com/rockbite/localforge) ⭐ 352 | 🐛 13 | 🌐 JavaScript | 📅 2025-05-18 on-prem AI coding autonomous assistant that lives inside your repo, edits and tests files at SSD speed. Think Claude Code but with UI. plug in any LLM (OpenAI, Gemini, Ollama, etc.) and let it work for you.
* [DVClive](https://github.com/iterative/dvclive) ⭐ 187 | 🐛 33 | 🌐 Python | 📅 2026-03-02 - Python library for experiment metrics logging into simply formatted local files.
* [Agentic Signal](https://github.com/code-forge-temple/agentic-signal) ⭐ 141 | 🐛 2 | 🌐 TypeScript | 📅 2026-02-07 - Visual AI agent workflow automation platform with local LLM integration. Build intelligent workflows using drag-and-drop, no cloud required.
...
* [Local LLM NPC](https://github.com/code-forge-temple/local-llm-npc) ⭐ 43 | 🐛 0 | 🌐 C# | 📅 2026-02-26 - Godot 4.x asset that enables NPCs to interact with players using local LLMs for structured, offline-first learning conversations in games.
...
* [ScribePal](https://github.com/code-forge-temple/scribe-pal) ⭐ 22 | 🐛 7 | 🌐 TypeScript | 📅 2026-03-05 - Chrome extension that uses local LLMs to assist with writing and drafting responses based on the context of your open tabs.
* [Awesome Hugging Face Models](https://github.com/JehoshuaM/awesome-huggingface-models) ⭐ 5 | 🐛 0 | 📅 2026-03-06 - Curated list of top Hugging Face models for NLP, vision, and audio tasks with demos and benchmarks.
...
* [Distributed Machine Learning Patterns](https://github.com/terrytangyuan/distributed-ml-patterns) ⭐ 493 | 🐛 0 | 🌐 Python | 📅 2026-01-06  - This book teaches you how to take machine learning models from your personal laptop to large distributed clusters. You’ll explore key concepts and patterns behind successful distributed machine learning systems, and learn technologies like TensorFlow, Kubernetes, Kubeflow, and Argo Workflows directly from a key maintainer and contributor, with real-world scenarios and hands-on projects.
...
* Some of the python libraries were cut-and-pasted from [vinta](https://github.com/vinta/awesome-python) ⭐ 286,095 | 🐛 20 | 🌐 Python | 📅 2026-03-04
